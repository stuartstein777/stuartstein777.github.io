...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38814 = c;
var G__38814__$1 = (((G__38814 == null))?null:G__38814.prototype);
if((G__38814__$1 == null)){
return null;
} else {
return G__38814__$1.reagentRender;
}
})() == null)))));
});
...
var or__4126__auto__ = (function (){var G__38829 = c;
var G__38829__$1 = (((G__38829 == null))?null:G__38829.constructor);
if((G__38829__$1 == null)){
return null;
} else {
return G__38829__$1.displayName;
}
})();
...
var _STAR_current_component_STAR__orig_val__38836 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38837 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38837);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38836);
}});
...
var c = this;
var G__38847_38966 = goog.object.get(c,"cljsRatom");
if((G__38847_38966 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38847_38966);
}
...
var renders_38967 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_38968 = cljs.core.first(cljs.core.vals(renders_38967));
...
if((cljs.core.count(renders_38967) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38967))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38968)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38968], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38856 = o;
goog.object.set(G__38856,cljs.core.name(k),v);
...
return (function() { 
var G__38977__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
return G__38977__delegate.call(this,args);};
G__38977.cljs$lang$maxFixedArity = 0;
G__38977.cljs$lang$applyTo = (function (arglist__38980){
var args = cljs.core.seq(arglist__38980);
return G__38977__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__38914 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38915 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38915);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38914);
}});
...
var vec__38939 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38939,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38939,(1),null);
...
var G__38942 = goog.object.get(reagent_state,"cljsRatom");
if((G__38942 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__38942);
}
});
}),[]);
