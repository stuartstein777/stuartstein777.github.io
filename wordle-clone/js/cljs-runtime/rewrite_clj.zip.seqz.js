...
var G__36499 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__36499__$1 = (((G__36499 == null))?null:cljs.core.iterate((function (loc){
...
var G__36499__$2 = (((G__36499__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__36499__$1));
var G__36499__$3 = (((G__36499__$2 == null))?null:cljs.core.last(G__36499__$2));
if((G__36499__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__36499__$3);
}
} else {
return zloc;
}
...
var G__36543 = rewrite_clj.zip.move.right(v);
var G__36544 = rewrite_clj.zip.move.up(v);
loc = G__36543;
parent = G__36544;
continue;
} else {
var G__36545 = rewrite_clj.zip.move.right(v0);
var G__36546 = parent;
loc = G__36545;
parent = G__36546;
continue;
...
var G__36547 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__36548 = rewrite_clj.zip.move.up(v);
loc = G__36547;
parent = G__36548;
continue;
} else {
var G__36549 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__36550 = parent;
loc = G__36549;
parent = G__36550;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__36526 = zloc;
var G__36526__$1 = (((G__36526 == null))?null:rewrite_clj.zip.move.down(G__36526));
var G__36526__$2 = (((G__36526__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__36526__$1,k));
if((G__36526__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__36526__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__36527 = rewrite_clj.zip.move.down(zloc);
var G__36527__$1 = (((G__36527 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__36527));
if((G__36527__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__36527__$1);
}
})(),k);
}
});
