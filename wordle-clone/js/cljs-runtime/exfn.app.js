...
var G__30260 = (row_guess.cljs$core$IFn$_invoke$arity$1 ? row_guess.cljs$core$IFn$_invoke$arity$1(col) : row_guess.call(null,col));
var fexpr__30259 = cljs.core.set(word);
return (fexpr__30259.cljs$core$IFn$_invoke$arity$1 ? fexpr__30259.cljs$core$IFn$_invoke$arity$1(G__30260) : fexpr__30259.call(null,G__30260));
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30264),exfn$app$guess_row_$_iter__30261(cljs.core.chunk_rest(s__30262__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30264),null);
}
} else {
var n = cljs.core.first(s__30262__$2);
...
})(),new cljs.core.Keyword(null,"data-guessed","data-guessed",-1563603296),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),(current_row - row_no)),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(["data-won",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),(current_row - row_no))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(game_state,new cljs.core.Keyword(null,"won","won",910394405)))),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),exfn.app.guess_background(n,row_no)], null),new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(row_no),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')]),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(rows,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [row_no,n], null))], null),exfn$app$guess_row_$_iter__30261(cljs.core.rest(s__30262__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.keyboard-row","div.keyboard-row",-1229156960),(function (){var iter__4529__auto__ = (function exfn$app$keyboard_row_$_iter__30265(s__30266){
return (new cljs.core.LazySeq(null,(function (){
var s__30266__$1 = s__30266;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__30266__$1);
if(temp__5735__auto__){
var s__30266__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30266__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__30266__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__30268 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__30267 = (0);
while(true){
if((i__30267 < size__4528__auto__)){
var letter = cljs.core._nth(c__4527__auto__,i__30267);
cljs.core.chunk_append(b__30268,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.keyboard-key","div.keyboard-key",-1302360613),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__30267,letter,c__4527__auto__,size__4528__auto__,b__30268,s__30266__$2,temp__5735__auto__,guessed_letters){
return (function (){
...
});})(i__30267,letter,c__4527__auto__,size__4528__auto__,b__30268,s__30266__$2,temp__5735__auto__,guessed_letters))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30268),exfn$app$keyboard_row_$_iter__30265(cljs.core.chunk_rest(s__30266__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30268),null);
}
} else {
var letter = cljs.core.first(s__30266__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.keyboard-key","div.keyboard-key",-1302360613),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (letter,s__30266__$2,temp__5735__auto__,guessed_letters){
return (function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"clicked","clicked",114423720),letter], null));
});})(letter,s__30266__$2,temp__5735__auto__,guessed_letters))
,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),exfn.app.get_key_bg(guessed_letters,letter)], null),new cljs.core.Keyword(null,"key","key",-1516042587),letter], null),letter], null),exfn$app$keyboard_row_$_iter__30265(cljs.core.rest(s__30266__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30272),exfn$app$app_$_iter__30269(cljs.core.chunk_rest(s__30270__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30272),null);
}
} else {
var n = cljs.core.first(s__30270__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [exfn.app.guess_row,current_row,current_col,rows,error,n,game_state], null),exfn$app$app_$_iter__30269(cljs.core.rest(s__30270__$2)));
}
} else {
return null;
}
