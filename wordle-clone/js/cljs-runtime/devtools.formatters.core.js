...
}catch (e30061){var _e__27752__auto__ = e30061;
return false;
...
}catch (e30063){var _e__27752__auto__ = e30063;
return false;
...
}catch (e30068){var _e__27752__auto__ = e30068;
return false;
...
}catch (e30074){var _e__27752__auto__ = e30074;
return false;
...
}catch (e30085){var _e__27752__auto__ = e30085;
return false;
}})())){
...
}catch (e30091){var _e__27752__auto__ = e30091;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__30095 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30096 = (function (){var or__4126__auto__ = config;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30096);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30095);
}});
});
...
while (G__30138__i < G__30138__a.length) {G__30138__a[G__30138__i] = arguments[G__30138__i + 0]; ++G__30138__i;}
  args = new cljs.core.IndexedSeq(G__30138__a,0,null);
} 
