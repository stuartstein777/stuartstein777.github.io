...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"history-list",new cljs.core.Keyword(null,"height","height",1025178622),"20%",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__4529__auto__ = (function day8$re_frame_10x$view$history$render_$_iter__40240(s__40241){
return (new cljs.core.LazySeq(null,(function (){
var s__40241__$1 = s__40241;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__40241__$1);
if(temp__5735__auto__){
var s__40241__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__40241__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__40241__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__40243 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__40242 = (0);
while(true){
if((i__40242 < size__4528__auto__)){
var vec__40247 = cljs.core._nth(c__4527__auto__,i__40242);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40247,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40247,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
cljs.core.chunk_append(b__40243,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__40265 = (i__40242 + (1));
i__40242 = G__40265;
continue;
} else {
var G__40266 = (i__40242 + (1));
i__40242 = G__40266;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40243),day8$re_frame_10x$view$history$render_$_iter__40240(cljs.core.chunk_rest(s__40241__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40243),null);
}
} else {
var vec__40254 = cljs.core.first(s__40241__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40254,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40254,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$history$render_$_iter__40240(cljs.core.rest(s__40241__$2)));
} else {
var G__40268 = cljs.core.rest(s__40241__$2);
s__40241__$1 = G__40268;
continue;
}
}
} else {
