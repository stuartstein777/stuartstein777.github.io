...
return [(function (){var pred__39381 = cljs.core.instance_QMARK_;
var expr__39382 = reactive_val;
if(cljs.core.truth_((pred__39381.cljs$core$IFn$_invoke$arity$2 ? pred__39381.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__39382) : pred__39381.call(null,reagent.ratom.RAtom,expr__39382)))){
return "ra";
} else {
if(cljs.core.truth_((pred__39381.cljs$core$IFn$_invoke$arity$2 ? pred__39381.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__39382) : pred__39381.call(null,reagent.ratom.RCursor,expr__39382)))){
return "rc";
} else {
if(cljs.core.truth_((pred__39381.cljs$core$IFn$_invoke$arity$2 ? pred__39381.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__39382) : pred__39381.call(null,reagent.ratom.Reaction,expr__39382)))){
return "rx";
} else {
if(cljs.core.truth_((pred__39381.cljs$core$IFn$_invoke$arity$2 ? pred__39381.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__39382) : pred__39381.call(null,reagent.ratom.Track,expr__39382)))){
return "tr";
} else {
return "other";
}
