...
return [(function (){var pred__34203 = cljs.core.instance_QMARK_;
var expr__34204 = reactive_val;
if(cljs.core.truth_((pred__34203.cljs$core$IFn$_invoke$arity$2 ? pred__34203.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__34204) : pred__34203.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__34204)))){
return "ra";
} else {
if(cljs.core.truth_((pred__34203.cljs$core$IFn$_invoke$arity$2 ? pred__34203.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__34204) : pred__34203.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__34204)))){
return "rc";
} else {
if(cljs.core.truth_((pred__34203.cljs$core$IFn$_invoke$arity$2 ? pred__34203.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__34204) : pred__34203.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__34204)))){
return "rx";
} else {
if(cljs.core.truth_((pred__34203.cljs$core$IFn$_invoke$arity$2 ? pred__34203.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__34204) : pred__34203.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__34204)))){
return "tr";
} else {
return "other";
}
