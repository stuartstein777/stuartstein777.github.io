...
var o28122 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28122["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28123 = temp__5733__auto____$1;
return (o28123["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27452__auto__ = f;
return (o__27452__auto__["toString"]).call(o__27452__auto__);
} else {
return "";
}
}catch (e28128){var _ = e28128;
return "";
}});
...
try{var o__27452__auto___28532 = t;
(o__27452__auto___28532["cljs$lang$ctorPrWriter"]).call(o__27452__auto___28532,t,writer);
}catch (e28136){var __28533 = e28136;
}
...
var char_code = (function (){var o__27452__auto__ = (new String(char$));
return (o__27452__auto__["charCodeAt"]).call(o__27452__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27452__auto__ = String;
return (o__27452__auto__["fromCharCode"]).call(o__27452__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28153 = num_code;
switch (G__28153) {
case (1):
return (185);
...
var o__27452__auto__ = String;
return (o__27452__auto__["fromCharCode"]).call(o__27452__auto__,superscript_code);
});
/**
...
}catch (e28164){var _e__27460__auto__ = e28164;
return false;
}})())){
...
var vec__28165 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28165,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o28187 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28187["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28188 = temp__5733__auto____$1;
return (o28188["nameToPath"]);
} else {
return null;
}
} else {
...
while(true){
if((i__4737__auto___28602 < len__4736__auto___28599)){
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28200){
var vec__28202 = p__28200;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28202,(0),null);
...
var G__28613 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28614 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28613;
remaining_tokens = G__28614;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28193){
var G__28194 = cljs.core.first(seq28193);
var seq28193__$1 = cljs.core.next(seq28193);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28194,seq28193__$1);
}));
...
var vec__28218 = cljs.core.split_with((function (p1__28214_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28214_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28218,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28218,(1),null);
...
var vec__28228 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28228,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28228,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28625 = cljs.core.rest(remaining_tokens);
var G__28626 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28625;
name_tokens = G__28626;
continue;
} else {
...
var vec__28257 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28257,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28257,(1),null);
var vec__28260 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28260,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28260,(1),null);
var vec__28263 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28263,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28263,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28263,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28263,(3),null);
...
var vec__28281 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28281,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28281,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28281,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28281,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28281,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28281,(5),null);
...
var vec__28297 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28297,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28297,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28310 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28310) : devtools.munging.parse_fn_info_deep.call(null,G__28310));
})()));
}
} else {
return fn_info;
...
var G__28669 = (arity + (1));
var G__28670 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28317){
var vec__28319 = p__28317;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28319,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28319,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28340_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28341_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28341_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28349){
var vec__28350 = p__28349;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28350,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28347){
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28427__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28427__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28427__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28427__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28428 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28428,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28428,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28428,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28428,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28428,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28428,(5),null);
...
var o__27452__auto__ = f;
return (o__27452__auto__["getBasis"]).call(o__27452__auto__);
});
/**
...
}catch (e28444){var _e__27460__auto__ = e28444;
...
var G__28694 = (obj[cljs.core.first(path)]);
var G__28695 = cljs.core.rest(path);
obj = G__28694;
path = G__28695;
continue;
} else {
...
var _STAR_ = (function (accum,p__28485){
var vec__28486 = p__28485;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28486,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28486,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28504){
var vec__28505 = p__28504;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28505,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28505,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28505,(2),null);
...
var post_process = (function (p__28515){
var vec__28517 = p__28515;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28517,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28517,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28512_SHARP_){
return (obj[cljs.core.first(p1__28512_SHARP_)]);
}),sorted_matches);
