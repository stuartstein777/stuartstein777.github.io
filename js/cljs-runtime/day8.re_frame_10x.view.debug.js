...
var iter__4529__auto__ = (function day8$re_frame_10x$view$debug$render_$_iter__40390(s__40391){
return (new cljs.core.LazySeq(null,(function (){
var s__40391__$1 = s__40391;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__40391__$1);
if(temp__5735__auto__){
var s__40391__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__40391__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__40391__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__40393 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__40392 = (0);
while(true){
if((i__40392 < size__4528__auto__)){
var match = cljs.core._nth(c__4527__auto__,i__40392);
var match_info = new cljs.core.Keyword(null,"match-info","match-info",666319879).cljs$core$IFn$_invoke$arity$1(match);
cljs.core.chunk_append(b__40393,cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"border","border",1444987323),"1px solid black",new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(current_match,match_info))?"bold":"normal")], null),new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__40392,match_info,match,c__4527__auto__,size__4528__auto__,b__40393,s__40391__$2,temp__5735__auto__,current_match){
...
});})(i__40392,match_info,match,c__4527__auto__,size__4528__auto__,b__40393,s__40391__$2,temp__5735__auto__,current_match))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40393),day8$re_frame_10x$view$debug$render_$_iter__40390(cljs.core.chunk_rest(s__40391__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40393),null);
}
} else {
var match = cljs.core.first(s__40391__$2);
var match_info = new cljs.core.Keyword(null,"match-info","match-info",666319879).cljs$core$IFn$_invoke$arity$1(match);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"border","border",1444987323),"1px solid black",new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(current_match,match_info))?"bold":"normal")], null),new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (match_info,match,s__40391__$2,temp__5735__auto__,current_match){
return (function (event){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.label,new cljs.core.Keyword(null,"label","label",1718410804),cljs.core.prn_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([event], 0))], null);
});})(match_info,match,s__40391__$2,temp__5735__auto__,current_match))
,day8.re_frame_10x.metamorphic.summarise_match(match_info)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(cljs.core.first(match_info))], null)),day8$re_frame_10x$view$debug$render_$_iter__40390(cljs.core.rest(s__40391__$2)));
}
} else {
return null;
}
