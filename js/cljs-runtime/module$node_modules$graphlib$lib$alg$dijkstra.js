...
v$jscomp$0,pq.decrease(w,distance))};for(g.nodes().forEach(function(v){var distance=v===source?0:Number.POSITIVE_INFINITY;results[v]={distance:distance};pq.add(v,distance)});0<pq.size();){var v$jscomp$0=pq.removeMin();var vEntry=results[v$jscomp$0];if(vEntry.distance===Number.POSITIVE_INFINITY)break;edgeFn(v$jscomp$0).forEach(updateNeighbors)}return results}global=require("module$node_modules$graphlib$lib$lodash");var PriorityQueue=require("module$node_modules$graphlib$lib$data$priority_queue");module.exports=
