...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38884 = c;
var G__38884__$1 = (((G__38884 == null))?null:G__38884.prototype);
if((G__38884__$1 == null)){
return null;
} else {
return G__38884__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38889 = c;
var G__38889__$1 = (((G__38889 == null))?null:G__38889.prototype);
if((G__38889__$1 == null)){
return null;
} else {
return G__38889__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__39046__delegate = function (args){
...
while (G__39047__i < G__39047__a.length) {G__39047__a[G__39047__i] = arguments[G__39047__i + 0]; ++G__39047__i;}
  args = new cljs.core.IndexedSeq(G__39047__a,0,null);
} 
return G__39046__delegate.call(this,args);};
G__39046.cljs$lang$maxFixedArity = 0;
G__39046.cljs$lang$applyTo = (function (arglist__39048){
var args = cljs.core.seq(arglist__39048);
return G__39046__delegate(args);
});
...
var or__4126__auto__ = (function (){var G__38908 = c;
var G__38908__$1 = (((G__38908 == null))?null:G__38908.constructor);
if((G__38908__$1 == null)){
return null;
} else {
return G__38908__$1.displayName;
}
})();
...
var G__38912 = c;
var G__38912__$1 = (((G__38912 == null))?null:G__38912.constructor);
if((G__38912__$1 == null)){
return null;
} else {
return G__38912__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38913 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38914 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38914);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38913);
}});
...
var c = this;
var G__38945_39065 = goog.object.get(c,"cljsRatom");
if((G__38945_39065 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38945_39065);
}
...
var renders_39076 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_39077 = cljs.core.first(cljs.core.vals(renders_39076));
...
if((cljs.core.count(renders_39076) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_39076))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_39077)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_39077], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38987 = o;
goog.object.set(G__38987,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__39013 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__39014 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__39014);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__39013);
}});
...
var vec__39016 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39016,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39016,(1),null);
...
var G__39022 = goog.object.get(reagent_state,"cljsRatom");
if((G__39022 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__39022);
}
});
}),[]);
