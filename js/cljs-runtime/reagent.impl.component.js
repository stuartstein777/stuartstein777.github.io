...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38816 = c;
var G__38816__$1 = (((G__38816 == null))?null:G__38816.prototype);
if((G__38816__$1 == null)){
return null;
} else {
return G__38816__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38821 = c;
var G__38821__$1 = (((G__38821 == null))?null:G__38821.prototype);
if((G__38821__$1 == null)){
return null;
} else {
return G__38821__$1.render;
}
})() == null)))));
});
...
while (G__38978__i < G__38978__a.length) {G__38978__a[G__38978__i] = arguments[G__38978__i + 0]; ++G__38978__i;}
  args = new cljs.core.IndexedSeq(G__38978__a,0,null);
} 
return G__38974__delegate.call(this,args);};
G__38974.cljs$lang$maxFixedArity = 0;
G__38974.cljs$lang$applyTo = (function (arglist__38979){
var args = cljs.core.seq(arglist__38979);
...
var or__4126__auto__ = (function (){var G__38830 = c;
var G__38830__$1 = (((G__38830 == null))?null:G__38830.constructor);
if((G__38830__$1 == null)){
return null;
} else {
return G__38830__$1.displayName;
}
})();
...
var G__38831 = c;
var G__38831__$1 = (((G__38831 == null))?null:G__38831.constructor);
if((G__38831__$1 == null)){
return null;
} else {
return G__38831__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38835 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38836 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38836);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38835);
}});
...
var c = this;
var G__38860_38999 = goog.object.get(c,"cljsRatom");
if((G__38860_38999 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38860_38999);
}
...
var renders_39001 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_39002 = cljs.core.first(cljs.core.vals(renders_39001));
...
if((cljs.core.count(renders_39001) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_39001))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_39002)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_39002], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38909 = o;
goog.object.set(G__38909,cljs.core.name(k),v);
...
return (function() { 
var G__39017__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
G__39017.cljs$lang$applyTo = (function (arglist__39020){
...
var _STAR_current_component_STAR__orig_val__38944 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38945 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38945);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38944);
}});
...
var vec__38953 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38953,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38953,(1),null);
...
var G__38960 = goog.object.get(reagent_state,"cljsRatom");
if((G__38960 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__38960);
}
});
}),[]);
