...
var G__28995 = (i__4737__auto___28993 + (1));
i__4737__auto___28993 = G__28995;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28886){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28924_SHARP_){
return (!((cljs.core.meta(p1__28924_SHARP_) == null)));
})))){
...
}catch (e28943){var _e__27426__auto__ = e28943;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e28946){var _e__27426__auto__ = e28946;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28955 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28956 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28956);

try{var map__28957 = opts;
var map__28957__$1 = (((((!((map__28957 == null))))?(((((map__28957.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28957.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28957):map__28957);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28957__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28955);
}});
...
var temp__5733__auto___29040 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___29040)){
var managed_print_level_29041 = temp__5733__auto___29040;
var _STAR_print_level_STAR__orig_val__28973_29042 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28974_29043 = managed_print_level_29041;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28974_29043);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28966_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28966_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28973_29042);
}} else {
job_fn();
}
