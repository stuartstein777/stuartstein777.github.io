...
var G__31861 = (i__4737__auto___31858 + (1));
i__4737__auto___31858 = G__31861;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31774){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31775,G__31776,seq31774__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31786_SHARP_){
return (!((cljs.core.meta(p1__31786_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31798__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31805){var _e__25942__auto__ = e31805;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e31807){var _e__25942__auto__ = e31807;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31813 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31814 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31814);

try{var map__31817 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31817__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31813);
}});
...
var temp__5733__auto___31884 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___31884)){
var managed_print_level_31885 = temp__5733__auto___31884;
var _STAR_print_level_STAR__orig_val__31850_31886 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31851_31887 = managed_print_level_31885;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31851_31887);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31822_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31822_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31850_31886);
}} else {
job_fn();
}
