...
var len__4736__auto___28971 = arguments.length;
var i__4737__auto___28972 = (0);
while(true){
if((i__4737__auto___28972 < len__4736__auto___28971)){
args__4742__auto__.push((arguments[i__4737__auto___28972]));

var G__28973 = (i__4737__auto___28972 + (1));
i__4737__auto___28972 = G__28973;
continue;
} else {
}
break;
...
}catch (e28942){var _e__27460__auto__ = e28942;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e28944){var _e__27460__auto__ = e28944;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28947 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28948 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28948);

try{var map__28951 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28951__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28947);
}});
...
var temp__5733__auto___29006 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___29006)){
var managed_print_level_29007 = temp__5733__auto___29006;
var _STAR_print_level_STAR__orig_val__28962_29008 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28963_29009 = managed_print_level_29007;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28963_29009);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28957_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28957_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28962_29008);
}} else {
job_fn();
}
