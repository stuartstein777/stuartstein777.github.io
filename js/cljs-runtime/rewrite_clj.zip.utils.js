...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__36709,k,f){
var vec__36710 = p__36709;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36710,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36710,(1),null);
var loc = vec__36710;
...
var G__36862 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__36862;
continue;
}
break;
...
var G__36863 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__36863;
continue;
} else {
return zloc__$1;
...
var G__36864 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__36864;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__36759){
var vec__36761 = p__36759;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36761,(0),null);
var map__36764 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36761,(1),null);
...
var path = map__36764__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36764__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__36761;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__36820){
var vec__36821 = p__36820;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36821,(0),null);
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36824__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__36821;
if(cljs.core.seq(r)){
...
var vec__36832 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36832,(0),null);
var map__36835 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36832,(1),null);
...
var path = map__36835__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36835__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36835__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36835__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36835__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
