...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__32504,k,f){
var vec__32506 = p__32504;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32506,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32506,(1),null);
var loc = vec__32506;
...
var G__32544 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__32544;
continue;
}
break;
...
var G__32546 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__32546;
continue;
} else {
return zloc__$1;
...
var G__32547 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__32547;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__32513){
var vec__32514 = p__32513;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32514,(0),null);
var map__32517 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32514,(1),null);
...
var path = map__32517__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32517__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__32514;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__32521){
var vec__32522 = p__32521;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32522,(0),null);
var map__32525 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32522,(1),null);
...
var path = map__32525__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32525__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__32522;
if(cljs.core.seq(r)){
...
var vec__32531 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32531,(0),null);
var map__32534 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32531,(1),null);
var map__32534__$1 = (((((!((map__32534 == null))))?(((((map__32534.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32534.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__32534):map__32534);
var path = map__32534__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32534__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32534__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32534__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32534__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
