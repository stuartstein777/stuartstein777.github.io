...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__36887,k,f){
var vec__36888 = p__36887;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36888,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36888,(1),null);
var loc = vec__36888;
...
var G__36939 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__36939;
continue;
}
break;
...
var G__36940 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__36940;
continue;
} else {
return zloc__$1;
...
var G__36941 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__36941;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__36904){
var vec__36907 = p__36904;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36907,(0),null);
var map__36910 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36907,(1),null);
...
var path = map__36910__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36910__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__36907;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__36917){
var vec__36918 = p__36917;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36918,(0),null);
var map__36921 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36918,(1),null);
...
var path = map__36921__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36921__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__36918;
if(cljs.core.seq(r)){
...
var vec__36929 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36929,(0),null);
var map__36932 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36929,(1),null);
...
var path = map__36932__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36932__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36932__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36932__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36932__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
