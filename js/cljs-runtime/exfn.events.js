...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-source","update-source",-132063591),(function (db,p__56150){
var vec__56151 = p__56150;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56151,(0),null);
var source = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56151,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"parse","parse",-1162164619),(function (p__56154,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56155__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-scroll","update-scroll",-585233806),(function (p__56157,p__56158){
...
var scroll_pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56160,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"toggle-breakpoint","toggle-breakpoint",61273766),(function (p__56164,p__56165){
var map__56166 = p__56164;
...
var db = map__56166__$1;
var breakpoints = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56166__$1,new cljs.core.Keyword(null,"breakpoints","breakpoints",1018731739));
var vec__56167 = p__56165;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56167,(0),null);
var line_no = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56167,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-handle","set-handle",357208178),(function (db,p__56171){
var vec__56172 = p__56171;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56172,(0),null);
var handle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56172,(1),null);
...
re_frame.core.reg_fx(new cljs.core.Keyword(null,"toggle-running","toggle-running",2059919510),(function (p__56175){
var vec__56176 = p__56175;
var running_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56176,(0),null);
var handle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56176,(1),null);
var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56176,(2),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"toggle-running","toggle-running",2059919510),(function (p__56179,_){
var map__56180 = p__56179;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56180__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_fx(new cljs.core.Keyword(null,"end-if-finished","end-if-finished",1848036361),(function (p__56182){
var vec__56183 = p__56182;
var handle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56183,(0),null);
var finished_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56183,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"reset","reset",-800929946),(function (p__56186,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56187__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"next-instruction","next-instruction",-1250475904),(function (p__56189,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56190__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__56192 = exfn.interpreter.interpret((db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"code","code",1586293142)) : db.call(null,new cljs.core.Keyword(null,"code","code",1586293142))),(db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"memory","memory",-1449401430)) : db.call(null,new cljs.core.Keyword(null,"memory","memory",-1449401430))));
var map__56192__$1 = (((((!((map__56192 == null))))?(((((map__56192.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56192.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56192):map__56192);
var memory = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56192__$1,new cljs.core.Keyword(null,"memory","memory",-1449401430));
var finished_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56192__$1,new cljs.core.Keyword(null,"finished?","finished?",2067288119));
var terminated_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56192__$1,new cljs.core.Keyword(null,"terminated?","terminated?",209866129));
...
if((!(((function (){var G__56194 = new cljs.core.Keyword(null,"eip","eip",-346827869).cljs$core$IFn$_invoke$arity$1(memory);
return (breakpoints.cljs$core$IFn$_invoke$arity$1 ? breakpoints.cljs$core$IFn$_invoke$arity$1(G__56194) : breakpoints.call(null,G__56194));
})() == null)))){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"add-value-to-registers","add-value-to-registers",-532527242),(function (db,p__56195){
var vec__56196 = p__56195;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56196,(0),null);
var vec__56199 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56196,(1),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56199,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56199,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-running-speed","update-running-speed",-1892375383),(function (db,p__56202){
var vec__56203 = p__56202;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56203,(0),null);
var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56203,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"add-value-to-stack","add-value-to-stack",-680759018),(function (db,p__56206){
var vec__56207 = p__56206;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56207,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56207,(1),null);
