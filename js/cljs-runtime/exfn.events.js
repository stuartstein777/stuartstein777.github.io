...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-source","update-source",-132063591),(function (db,p__34652){
var vec__34653 = p__34652;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34653,(0),null);
var source = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34653,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"parse","parse",-1162164619),(function (p__34656,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34657__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-scroll","update-scroll",-585233806),(function (p__34659,p__34660){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34661__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__34662 = p__34660;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34662,(0),null);
var scroll_pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34662,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"toggle-breakpoint","toggle-breakpoint",61273766),(function (p__34666,p__34667){
...
var db = map__34668__$1;
var breakpoints = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34668__$1,new cljs.core.Keyword(null,"breakpoints","breakpoints",1018731739));
var vec__34669 = p__34667;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34669,(0),null);
var line_no = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34669,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-handle","set-handle",357208178),(function (db,p__34673){
var vec__34674 = p__34673;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34674,(0),null);
var handle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34674,(1),null);
...
re_frame.core.reg_fx(new cljs.core.Keyword(null,"toggle-running","toggle-running",2059919510),(function (p__34677){
var vec__34678 = p__34677;
var running_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34678,(0),null);
var handle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34678,(1),null);
var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34678,(2),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"toggle-running","toggle-running",2059919510),(function (p__34681,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34682__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_fx(new cljs.core.Keyword(null,"end-if-finished","end-if-finished",1848036361),(function (p__34684){
var vec__34685 = p__34684;
var handle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34685,(0),null);
var finished_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34685,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"reset","reset",-800929946),(function (p__34688,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34689__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"next-instruction","next-instruction",-1250475904),(function (p__34691,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34692__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__34694 = exfn.interpreter.interpret((db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"code","code",1586293142)) : db.call(null,new cljs.core.Keyword(null,"code","code",1586293142))),(db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"memory","memory",-1449401430)) : db.call(null,new cljs.core.Keyword(null,"memory","memory",-1449401430))));
var memory = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34694,(0),null);
var finished_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34694,(1),null);
...
if((!(((function (){var G__34697 = new cljs.core.Keyword(null,"eip","eip",-346827869).cljs$core$IFn$_invoke$arity$1(memory);
return (breakpoints.cljs$core$IFn$_invoke$arity$1 ? breakpoints.cljs$core$IFn$_invoke$arity$1(G__34697) : breakpoints.call(null,G__34697));
})() == null)))){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"add-value-to-registers","add-value-to-registers",-532527242),(function (db,p__34698){
var vec__34699 = p__34698;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34699,(0),null);
var vec__34702 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34699,(1),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34702,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34702,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-running-speed","update-running-speed",-1892375383),(function (db,p__34705){
var vec__34706 = p__34705;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34706,(0),null);
var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34706,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"add-value-to-stack","add-value-to-stack",-680759018),(function (db,p__34709){
var vec__34710 = p__34709;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34710,(0),null);
