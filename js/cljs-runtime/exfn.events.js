...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-scroll","update-scroll",-585233806),(function (p__29767,p__29768){
var map__29769 = p__29767;
var map__29769__$1 = (((((!((map__29769 == null))))?(((((map__29769.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29769.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29769):map__29769);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29769__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__29770 = p__29768;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29770,(0),null);
var scroll_pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29770,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"toggle-breakpoint","toggle-breakpoint",61273766),(function (p__29774,p__29775){
...
var db = map__29776__$1;
var breakpoints = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29776__$1,new cljs.core.Keyword(null,"breakpoints","breakpoints",1018731739));
var vec__29777 = p__29775;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29777,(0),null);
var line_no = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29777,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-handle","set-handle",357208178),(function (db,p__29781){
var vec__29782 = p__29781;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29782,(0),null);
var handle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29782,(1),null);
...
re_frame.core.reg_fx(new cljs.core.Keyword(null,"toggle-running","toggle-running",2059919510),(function (p__29785){
var vec__29786 = p__29785;
var running_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29786,(0),null);
var handle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29786,(1),null);
var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29786,(2),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"toggle-running","toggle-running",2059919510),(function (p__29789,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29790__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_fx(new cljs.core.Keyword(null,"end-if-finished","end-if-finished",1848036361),(function (p__29792){
var vec__29793 = p__29792;
var handle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29793,(0),null);
var finished_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29793,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"reset","reset",-800929946),(function (p__29796,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29797__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"next-instruction","next-instruction",-1250475904),(function (p__29799,_){
...
var vec__29802 = exfn.interpreter.interpret((db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"code","code",1586293142)) : db.call(null,new cljs.core.Keyword(null,"code","code",1586293142))),(db.cljs$core$IFn$_invoke$arity$1 ? db.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"memory","memory",-1449401430)) : db.call(null,new cljs.core.Keyword(null,"memory","memory",-1449401430))));
var memory = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29802,(0),null);
var finished_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29802,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"add-value-to-registers","add-value-to-registers",-532527242),(function (db,p__29805){
var vec__29806 = p__29805;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29806,(0),null);
var vec__29809 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29806,(1),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29809,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29809,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-running-speed","update-running-speed",-1892375383),(function (db,p__29812){
var vec__29813 = p__29812;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29813,(0),null);
var speed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29813,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"add-value-to-stack","add-value-to-stack",-680759018),(function (db,p__29816){
var vec__29817 = p__29816;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29817,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29817,(1),null);
