...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__31621_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__31621_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__31621_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__31625){
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__31635,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31636__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31636__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31636__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__31640 = (function (){var or__4126__auto__ = color;
...
var fexpr__31639 = (function (){var G__31641 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__31641) : style_map.call(null,G__31641));
})();
return (fexpr__31639.cljs$core$IFn$_invoke$arity$1 ? fexpr__31639.cljs$core$IFn$_invoke$arity$1(G__31640) : fexpr__31639.call(null,G__31640));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__31644){
var vec__31645 = p__31644;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31645,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31645,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31645,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__31650){
var vec__31651 = p__31650;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31651,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31651,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31651,(2),null);
...
var G__31816 = cljs.core.next(ssv);
var G__31817 = (this_ssv == null);
var G__31818 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__31819 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__31816;
doing_nil_QMARK_ = G__31817;
last_elide = G__31818;
out = G__31819;
continue;
}
...
var vec__31672 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31672,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31672,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31672,(2),null);
...
var G__31826 = cljs.core.next(remaining_cvec);
var G__31827 = new_idx;
var G__31828 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__31826;
idx = G__31827;
out = G__31828;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__31698,cursor_vec){
var vec__31699 = p__31698;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31699,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31699,(1),null);
var focus_vec = vec__31699;
...
var vec__31702 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31702,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31702,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__31705){
var vec__31706 = p__31705;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31706,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31706,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__31714,existing_count){
var vec__31715 = p__31714;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31715,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31715,(1),null);
...
return cljs.core.filterv((function (p1__31711_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__31711_SHARP_))));
...
var vec__31731 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31731,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31731,(1),null);
var cvec_element = vec__31731;
if((cvec_element == null)){
var G__31864 = cljs.core.next(cvec_nl);
var G__31865 = (idx + (1));
var G__31866 = start;
var G__31867 = out;
cvec_nl = G__31864;
...
var G__31868 = cljs.core.next(cvec_nl);
var G__31869 = (idx + (1));
var G__31870 = idx;
var G__31871 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__31868;
idx = G__31869;
start = G__31870;
out = G__31871;
...
var G__31873 = cljs.core.next(cvec_nl);
var G__31874 = (idx + (1));
var G__31875 = (idx + (1));
var G__31876 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__31873;
idx = G__31874;
start = G__31875;
out = G__31876;
...
var G__31879 = cljs.core.next(cvec_nl);
var G__31880 = (idx + (1));
var G__31881 = idx;
var G__31882 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__31879;
idx = G__31880;
start = G__31881;
out = G__31882;
...
var G__31884 = cljs.core.next(cvec_nl);
var G__31885 = (idx + (1));
var G__31886 = start;
var G__31887 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__31884;
idx = G__31885;
start = G__31886;
out = G__31887;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__31739_SHARP_,p2__31738_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__31738_SHARP_)){
return cljs.core.reduced(p1__31739_SHARP_);
} else {
return (p1__31739_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__31741,p__31742){
var vec__31743 = p__31741;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31743,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31743,(1),null);
var vec__31746 = p__31742;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31746,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31746,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__31759,cvec,focus_vec){
var map__31760 = p__31759;
var map__31760__$1 = (((((!((map__31760 == null))))?(((((map__31760.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31760.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31760):map__31760);
var options = map__31760__$1;
var map__31761 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31760__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31761__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31761__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31761__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31757_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__31757_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
