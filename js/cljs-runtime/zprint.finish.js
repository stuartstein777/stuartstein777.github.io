...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__35374_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__35374_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__35374_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__35376){
var vec__35377 = p__35376;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35377,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35377,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
...
var G__35394 = (function (){var or__4126__auto__ = color;
...
var fexpr__35393 = (function (){var G__35395 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__35395) : style_map.call(null,G__35395));
})();
return (fexpr__35393.cljs$core$IFn$_invoke$arity$1 ? fexpr__35393.cljs$core$IFn$_invoke$arity$1(G__35394) : fexpr__35393.call(null,G__35394));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__35397){
var vec__35398 = p__35397;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35398,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35398,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35398,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__35401){
var vec__35402 = p__35401;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35402,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35402,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35402,(2),null);
...
var G__35584 = cljs.core.next(ssv);
var G__35585 = (this_ssv == null);
var G__35586 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__35587 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__35584;
doing_nil_QMARK_ = G__35585;
last_elide = G__35586;
out = G__35587;
continue;
}
...
var vec__35411 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35411,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35411,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35411,(2),null);
...
var G__35590 = cljs.core.next(remaining_cvec);
var G__35591 = new_idx;
var G__35592 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__35590;
idx = G__35591;
out = G__35592;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__35426,cursor_vec){
var vec__35429 = p__35426;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35429,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35429,(1),null);
var focus_vec = vec__35429;
...
var vec__35435 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35435,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35435,(1),null);
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__35471,existing_count){
var vec__35472 = p__35471;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35472,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35472,(1),null);
...
return cljs.core.filterv((function (p1__35466_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__35466_SHARP_))));
...
var vec__35501 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35501,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35501,(1),null);
var cvec_element = vec__35501;
if((cvec_element == null)){
var G__35614 = cljs.core.next(cvec_nl);
var G__35615 = (idx + (1));
var G__35616 = start;
var G__35617 = out;
cvec_nl = G__35614;
...
var G__35619 = cljs.core.next(cvec_nl);
var G__35620 = (idx + (1));
var G__35621 = idx;
var G__35622 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__35619;
idx = G__35620;
start = G__35621;
out = G__35622;
...
var G__35623 = cljs.core.next(cvec_nl);
var G__35624 = (idx + (1));
var G__35625 = (idx + (1));
var G__35626 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__35623;
idx = G__35624;
start = G__35625;
out = G__35626;
...
var G__35627 = cljs.core.next(cvec_nl);
var G__35628 = (idx + (1));
var G__35629 = idx;
var G__35630 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__35627;
idx = G__35628;
start = G__35629;
out = G__35630;
...
var G__35631 = cljs.core.next(cvec_nl);
var G__35632 = (idx + (1));
var G__35633 = start;
var G__35634 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__35631;
idx = G__35632;
start = G__35633;
out = G__35634;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__35508_SHARP_,p2__35507_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__35507_SHARP_)){
return cljs.core.reduced(p1__35508_SHARP_);
} else {
return (p1__35508_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__35513,p__35514){
var vec__35515 = p__35513;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35515,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35515,(1),null);
var vec__35518 = p__35514;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35518,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35518,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__35527,cvec,focus_vec){
...
var options = map__35528__$1;
var map__35529 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35528__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35529__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35529__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35529__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35525_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__35525_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
