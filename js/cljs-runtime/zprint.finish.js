...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__35372_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__35372_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__35372_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__35373){
var vec__35374 = p__35373;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35374,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35374,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__35379,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35380__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35380__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35380__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__35386 = (function (){var or__4126__auto__ = color;
...
var fexpr__35385 = (function (){var G__35387 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__35387) : style_map.call(null,G__35387));
})();
return (fexpr__35385.cljs$core$IFn$_invoke$arity$1 ? fexpr__35385.cljs$core$IFn$_invoke$arity$1(G__35386) : fexpr__35385.call(null,G__35386));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__35388){
var vec__35389 = p__35388;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35389,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35389,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35389,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__35394){
var vec__35395 = p__35394;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35395,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35395,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35395,(2),null);
...
var G__35583 = cljs.core.next(ssv);
var G__35584 = (this_ssv == null);
var G__35585 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__35586 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__35583;
doing_nil_QMARK_ = G__35584;
last_elide = G__35585;
out = G__35586;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__35443,cursor_vec){
var vec__35444 = p__35443;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35444,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35444,(1),null);
var focus_vec = vec__35444;
...
var vec__35457 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35457,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35457,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__35466){
var vec__35469 = p__35466;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35469,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35469,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__35487,existing_count){
var vec__35488 = p__35487;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35488,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35488,(1),null);
...
return cljs.core.filterv((function (p1__35482_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__35482_SHARP_))));
...
var vec__35526 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35526,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35526,(1),null);
var cvec_element = vec__35526;
if((cvec_element == null)){
var G__35630 = cljs.core.next(cvec_nl);
var G__35631 = (idx + (1));
var G__35632 = start;
var G__35633 = out;
cvec_nl = G__35630;
...
var G__35635 = cljs.core.next(cvec_nl);
var G__35636 = (idx + (1));
var G__35637 = idx;
var G__35638 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__35635;
idx = G__35636;
start = G__35637;
out = G__35638;
...
var G__35643 = cljs.core.next(cvec_nl);
var G__35644 = (idx + (1));
var G__35645 = (idx + (1));
var G__35646 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__35643;
idx = G__35644;
start = G__35645;
out = G__35646;
...
var G__35648 = cljs.core.next(cvec_nl);
var G__35649 = (idx + (1));
var G__35650 = idx;
...
var G__35653 = cljs.core.next(cvec_nl);
var G__35654 = (idx + (1));
var G__35655 = start;
var G__35656 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__35653;
idx = G__35654;
start = G__35655;
out = G__35656;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__35548_SHARP_,p2__35547_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__35547_SHARP_)){
return cljs.core.reduced(p1__35548_SHARP_);
} else {
return (p1__35548_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__35553,p__35554){
var vec__35556 = p__35553;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35556,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35556,(1),null);
var vec__35559 = p__35554;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35559,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35559,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__35565,cvec,focus_vec){
...
var options = map__35566__$1;
var map__35567 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35566__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35567__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35567__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35567__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35564_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__35564_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
