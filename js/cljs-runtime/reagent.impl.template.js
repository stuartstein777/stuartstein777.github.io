...
var G__39104 = o;
goog.object.set(G__39104,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__39165__delegate = function (args){
...
while (G__39166__i < G__39166__a.length) {G__39166__a[G__39166__i] = arguments[G__39166__i + 0]; ++G__39166__i;}
  args = new cljs.core.IndexedSeq(G__39166__a,0,null);
} 
return G__39165__delegate.call(this,args);};
G__39165.cljs$lang$maxFixedArity = 0;
G__39165.cljs$lang$applyTo = (function (arglist__39167){
var args = cljs.core.seq(arglist__39167);
return G__39165__delegate(args);
});
...
var G__39117 = o;
goog.object.set(G__39117,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__39169.cljs$lang$applyTo = (function (arglist__39172){
...
var G__39120 = props;
var G__39120__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39120,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39120);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39120__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39121 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39121,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39121;
}
})(),id_class);
...
var G__39127 = (cljs.core.count(argv) - first_child);
switch (G__39127) {
case (0):
...
var vec__39131 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39131,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39131,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39131,(2),null);
...
var temp__5739__auto___39185 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39185 == null)){
} else {
var key_39186 = temp__5739__auto___39185;
(jsprops.key = key_39186);
}
...
var temp__5739__auto___39190 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39190 == null)){
} else {
var key_39191 = temp__5739__auto___39190;
(jsprops.key = key_39191);
}
...
var temp__5739__auto___39193 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___39193 == null)){
} else {
var key_39195 = temp__5739__auto___39193;
(jsprops.key = key_39195);
}
...
var temp__5739__auto___39201 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39201 == null)){
} else {
var key_39202 = temp__5739__auto___39201;
(jsprops.key = key_39202);
}
...
var temp__5739__auto___39209 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39209 == null)){
} else {
var key_39210 = temp__5739__auto___39209;
(jsprops.key = key_39210);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39137_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39137_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39138 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39138,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39138,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template39149 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template39149 = (function (opts,id,fn_to_element,meta39150){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39149.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39151,meta39150__$1){
var self__ = this;
var _39151__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39149(self__.opts,self__.id,self__.fn_to_element,meta39150__$1));
}));

(reagent.impl.template.t_reagent$impl$template39149.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39151){
var self__ = this;
var _39151__$1 = this;
return self__.meta39150;
}));

(reagent.impl.template.t_reagent$impl$template39149.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39149.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39149.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39149.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39149.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta39150","meta39150",782378856,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39149.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39149.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39149");

(reagent.impl.template.t_reagent$impl$template39149.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template39149");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39149.
 */
reagent.impl.template.__GT_t_reagent$impl$template39149 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template39149(opts__$1,id__$1,fn_to_element__$1,meta39150){
return (new reagent.impl.template.t_reagent$impl$template39149(opts__$1,id__$1,fn_to_element__$1,meta39150));
});

}

return (new reagent.impl.template.t_reagent$impl$template39149(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
