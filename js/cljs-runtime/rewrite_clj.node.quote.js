...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k36076,else__4383__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__36086){
var vec__36087 = p__36086;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36087,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36087,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__36075){
var self__ = this;
var G__36075__$1 = this;
return (new cljs.core.RecordIter((0),G__36075__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this36077,other36078){
var self__ = this;
var this36077__$1 = this;
return (((!((other36078 == null)))) && ((this36077__$1.constructor === other36078.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36077__$1.tag,other36078.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36077__$1.prefix,other36078.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36077__$1.sym,other36078.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36077__$1.children,other36078.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36077__$1.__extmap,other36078.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__36075){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__36099 = cljs.core.keyword_identical_QMARK_;
var expr__36100 = k__4388__auto__;
if(cljs.core.truth_((pred__36099.cljs$core$IFn$_invoke$arity$2 ? pred__36099.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__36100) : pred__36099.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__36100)))){
return (new rewrite_clj.node.quote.QuoteNode(G__36075,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36099.cljs$core$IFn$_invoke$arity$2 ? pred__36099.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__36100) : pred__36099.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__36100)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__36075,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36099.cljs$core$IFn$_invoke$arity$2 ? pred__36099.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__36100) : pred__36099.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__36100)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__36075,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36099.cljs$core$IFn$_invoke$arity$2 ? pred__36099.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__36100) : pred__36099.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__36100)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__36075,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__36075),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__36075){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__36075,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__36079){
var extmap__4419__auto__ = (function (){var G__36124 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__36079,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__36079)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__36124);
} else {
return G__36124;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__36079),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__36079),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__36079),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__36079),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__36191 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__36191;
continue;
}
break;
...
var G__36195 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__36195;
continue;
}
break;
...
var G__36196 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__36196;
continue;
}
break;
...
var G__36200 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__36200;
continue;
}
break;
