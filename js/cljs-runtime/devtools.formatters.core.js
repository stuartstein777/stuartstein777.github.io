...
}catch (e30584){var _e__27426__auto__ = e30584;
return false;
...
}catch (e30591){var _e__27426__auto__ = e30591;
return false;
...
}catch (e30608){var _e__27426__auto__ = e30608;
return false;
...
}catch (e30612){var _e__27426__auto__ = e30612;
return false;
...
}catch (e30615){var _e__27426__auto__ = e30615;
return false;
}})())){
...
}catch (e30623){var _e__27426__auto__ = e30623;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__30626 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30627 = (function (){var or__4126__auto__ = config;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30627);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30626);
}});
});
...
while (G__30656__i < G__30656__a.length) {G__30656__a[G__30656__i] = arguments[G__30656__i + 0]; ++G__30656__i;}
  args = new cljs.core.IndexedSeq(G__30656__a,0,null);
} 
