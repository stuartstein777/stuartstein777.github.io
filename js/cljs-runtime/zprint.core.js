...
var vec__39611 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__39614 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39614,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39614,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39611,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39611,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__39623){
var vec__39626 = p__39623;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39626,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39626,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39630,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39630,(1),null);
...
var vec__39650 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39650,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39650,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39650,(2),null);
var vec__39653 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39653,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39653,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39653,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__39675){
var vec__39676 = p__39675;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39676,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39676,(1),null);
...
var vec__39684 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39684,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39684,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39684,(2),null);
...
var vec__39706 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39706,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39706,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39706,(2),null);
var tuple = vec__39706;
...
var G__39976 = cljs.core.next(style_vec);
var G__39977 = ends_w_blanks_QMARK_;
var G__39978 = tuple;
var G__39979 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__39976;
previous_ends_w_blanks_QMARK_ = G__39977;
previous_tuple = G__39978;
out = G__39979;
continue;
}
break;
...
var vec__39734 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39734,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39734,(1),null);
...
var result = (function (){var G__39742 = zprint.core.parse_string_all_options(rest_options);
var G__39743 = zprint.core.zprint_str_internal;
var G__39744 = ":parse-string-all? call";
var G__39745 = (function (){var G__39749 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39749) : zprint.zutil.edn_STAR_.call(null,G__39749));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__39742,G__39743,G__39744,G__39745) : zprint.core.process_multiple_forms.call(null,G__39742,G__39743,G__39744,G__39745));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__39752 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39752,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39752,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq39715){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39716,G__39717,seq39715__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___40011 = arguments.length;
var i__4737__auto___40012 = (0);
while(true){
if((i__4737__auto___40012 < len__4736__auto___40011)){
args__4742__auto__.push((arguments[i__4737__auto___40012]));

var G__40013 = (i__4737__auto___40012 + (1));
i__4737__auto___40012 = G__40013;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq39772){
var G__39773 = cljs.core.first(seq39772);
var seq39772__$1 = cljs.core.next(seq39772);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39773,seq39772__$1);
}));
...
var i__4737__auto___40015 = (0);
while(true){
if((i__4737__auto___40015 < len__4736__auto___40014)){
args__4742__auto__.push((arguments[i__4737__auto___40015]));

var G__40016 = (i__4737__auto___40015 + (1));
i__4737__auto___40015 = G__40016;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq39779){
var G__39780 = cljs.core.first(seq39779);
var seq39779__$1 = cljs.core.next(seq39779);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39780,seq39779__$1);
}));
...
var i__4737__auto___40039 = (0);
while(true){
if((i__4737__auto___40039 < len__4736__auto___40035)){
args__4742__auto__.push((arguments[i__4737__auto___40039]));

var G__40040 = (i__4737__auto___40039 + (1));
i__4737__auto___40039 = G__40040;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq39781){
var G__39782 = cljs.core.first(seq39781);
var seq39781__$1 = cljs.core.next(seq39781);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39782,seq39781__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___40045 = arguments.length;
var i__4737__auto___40046 = (0);
while(true){
if((i__4737__auto___40046 < len__4736__auto___40045)){
args__4742__auto__.push((arguments[i__4737__auto___40046]));

var G__40047 = (i__4737__auto___40046 + (1));
i__4737__auto___40046 = G__40047;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq39786){
var G__39787 = cljs.core.first(seq39786);
var seq39786__$1 = cljs.core.next(seq39786);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39787,seq39786__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__39816,form){
var vec__39817 = p__39816;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39817,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39817,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39817,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39817,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__39820 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39820,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39820,(1),null);
...
var G__40063 = cljs.core.next(sos);
var G__40064 = comment_QMARK_;
var G__40065 = (function (){var or__4126__auto__ = (!(empty_string_QMARK_));
if(or__4126__auto__){
return or__4126__auto__;
} else {
...
var G__40066 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__40063;
previous_comment_QMARK_ = G__40064;
start_interpolating_QMARK_ = G__40065;
out = G__40066;
continue;
}
break;
...
try{var vec__39891 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39891,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39891,(1),null);
...
var vec__39894 = (cljs.core.truth_((function (){var or__4126__auto__ = range_start__$1;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39894,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39894,(1),null);
...
var vec__39897 = (cljs.core.truth_((function (){var and__4115__auto__ = actual_start;
if(cljs.core.truth_(and__4115__auto__)){
return actual_end;
} else {
return and__4115__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39897,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39897,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39897,(2),null);
...
var forms = (function (){var G__39904 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39904) : zprint.zutil.edn_STAR_.call(null,G__39904));
})();
