...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k36171,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k36171,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__36194){
var vec__36195 = p__36194;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36195,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36195,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__36170){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this36172,other36173){
var self__ = this;
var this36172__$1 = this;
return (((!((other36173 == null)))) && ((this36172__$1.constructor === other36173.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36172__$1.tag,other36173.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36172__$1.wrap_fn,other36173.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36172__$1.wrap_length,other36173.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36172__$1.seq_fn,other36173.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36172__$1.children,other36173.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36172__$1.__extmap,other36173.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__36260 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__36260) : self__.seq_fn.call(null,G__36260));
}));
...
var self__ = this;
var this$__$1 = this;
var G__36265 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__36265) : self__.wrap_fn.call(null,G__36265));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__36170){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__36277 = cljs.core.keyword_identical_QMARK_;
var expr__36278 = k__4388__auto__;
if(cljs.core.truth_((pred__36277.cljs$core$IFn$_invoke$arity$2 ? pred__36277.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__36278) : pred__36277.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__36278)))){
return (new rewrite_clj.node.seq.SeqNode(G__36170,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36277.cljs$core$IFn$_invoke$arity$2 ? pred__36277.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__36278) : pred__36277.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__36278)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__36170,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36277.cljs$core$IFn$_invoke$arity$2 ? pred__36277.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__36278) : pred__36277.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__36278)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__36170,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36277.cljs$core$IFn$_invoke$arity$2 ? pred__36277.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__36278) : pred__36277.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__36278)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__36170,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36277.cljs$core$IFn$_invoke$arity$2 ? pred__36277.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__36278) : pred__36277.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__36278)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__36170,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__36170),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__36170){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__36170,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__36174){
var extmap__4419__auto__ = (function (){var G__36288 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__36174,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__36174)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__36288);
} else {
return G__36288;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__36174),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__36174),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__36174),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__36174),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__36174),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__36289_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__36289_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__36297_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__36297_SHARP_);
}),children);
});
