...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k36276,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k36276,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__36310){
var vec__36311 = p__36310;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36311,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36311,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__36275){
var self__ = this;
var G__36275__$1 = this;
return (new cljs.core.RecordIter((0),G__36275__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this36277,other36278){
var self__ = this;
var this36277__$1 = this;
return (((!((other36278 == null)))) && ((this36277__$1.constructor === other36278.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36277__$1.tag,other36278.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36277__$1.wrap_fn,other36278.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36277__$1.wrap_length,other36278.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36277__$1.seq_fn,other36278.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36277__$1.children,other36278.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36277__$1.__extmap,other36278.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__36320 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__36320) : self__.seq_fn.call(null,G__36320));
}));
...
var self__ = this;
var this$__$1 = this;
var G__36321 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__36321) : self__.wrap_fn.call(null,G__36321));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__36275){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__36333 = cljs.core.keyword_identical_QMARK_;
var expr__36334 = k__4388__auto__;
if(cljs.core.truth_((pred__36333.cljs$core$IFn$_invoke$arity$2 ? pred__36333.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__36334) : pred__36333.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__36334)))){
return (new rewrite_clj.node.seq.SeqNode(G__36275,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36333.cljs$core$IFn$_invoke$arity$2 ? pred__36333.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__36334) : pred__36333.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__36334)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__36275,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36333.cljs$core$IFn$_invoke$arity$2 ? pred__36333.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__36334) : pred__36333.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__36334)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__36275,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36333.cljs$core$IFn$_invoke$arity$2 ? pred__36333.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__36334) : pred__36333.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__36334)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__36275,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36333.cljs$core$IFn$_invoke$arity$2 ? pred__36333.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__36334) : pred__36333.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__36334)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__36275,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__36275),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__36275){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__36275,self__.__extmap,self__.__hash));
}));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__36279),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__36279),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__36279),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__36279),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__36279),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__36339_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__36339_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__36343_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__36343_SHARP_);
}),children);
});
