...
var G__28864 = devtools.prefs.pref(v);
v = G__28864;
continue;
} else {
return v;
...
}catch (e28787){var _e__27426__auto__ = e28787;
return false;
}})();
...
}catch (e28798){var _e__27426__auto__ = e28798;
return false;
}})();
...
}catch (e28800){var _e__27426__auto__ = e28800;
return false;
}}
}
});
...
var vec__28811 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28811,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28811,(1),null);
...
return cljs.core.some((function (p1__28848_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28848_SHARP_);
}),template);
});
