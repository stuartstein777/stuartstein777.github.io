...
this._edgeLabels[arg0]=valueSpecified?value:this._defaultEdgeLabelFn(v,w,name);v=""+v;w=""+w;!this._isDirected&&v>w&&(value=v,v=w,w=value);value={v:v,w:w};name&&(value.name=name);v=value.v;w=value.w;Object.freeze(value);this._edgeObjs[arg0]=value;name=this._preds[w];valueSpecified=v;name[valueSpecified]?name[valueSpecified]++:name[valueSpecified]=1;name=this._sucs[v];valueSpecified=w;name[valueSpecified]?name[valueSpecified]++:name[valueSpecified]=1;this._in[w][arg0]=value;this._out[v][arg0]=value;
this._edgeCount++;return this};Graph.prototype.edge=function(v,w,name){var e=1===arguments.length?edgeObjToId(this._isDirected,arguments[0]):edgeArgsToId(this._isDirected,v,w,name);return this._edgeLabels[e]};Graph.prototype.hasEdge=function(v,w,name){var e=1===arguments.length?edgeObjToId(this._isDirected,arguments[0]):edgeArgsToId(this._isDirected,v,w,name);return _.has(this._edgeLabels,e)};Graph.prototype.removeEdge=function(v,w,name){var e=1===arguments.length?edgeObjToId(this._isDirected,arguments[0]):
edgeArgsToId(this._isDirected,v,w,name),edge=this._edgeObjs[e];if(edge){v=edge.v;w=edge.w;delete this._edgeLabels[e];delete this._edgeObjs[e];edge=this._preds[w];var k=v;--edge[k]||delete edge[k];edge=this._sucs[v];k=w;--edge[k]||delete edge[k];delete this._in[w][e];delete this._out[v][e];this._edgeCount--}return this};Graph.prototype.inEdges=function(v,u){if(v=this._in[v])return v=_.values(v),u?_.filter(v,function(edge){return edge.v===u}):v};Graph.prototype.outEdges=function(v,w){if(v=this._out[v])return v=
_.values(v),w?_.filter(v,function(edge){return edge.w===w}):v};Graph.prototype.nodeEdges=function(v,w){var inEdges=this.inEdges(v,w);if(inEdges)return inEdges.concat(this.outEdges(v,w))}}
