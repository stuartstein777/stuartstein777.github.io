...
var G__37610 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__37610;
continue;
} else {
var G__37611 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__37611;
continue;
}
} else {
var G__37612 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__37612;
continue;
}
}
...
var G__37587 = zloc;
var G__37588 = (function (){var G__37589 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__37590 = zloc;
var G__37590__$1 = (((G__37590 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__37590) : rewrite_clj.zip.node.call(null,G__37590)));
if((G__37590__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__37590__$1) : zprint.zutil.edn_STAR_.call(null,G__37590__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__37589) : rewrite_clj.zip.root.call(null,G__37589));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__37587,G__37588) : rewrite_clj.zip.replace.call(null,G__37587,G__37588));
});
/**
...
var G__37614 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__37614;
continue;
}
break;
...
var G__37615 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__37616 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__37615;
out = G__37616;
continue;
} else {
...
var G__37617 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__37618 = cljs.core.next(new_loc);
var G__37619 = replaced_loc;
nloc = G__37617;
new_loc = G__37618;
last_loc = G__37619;
continue;
...
return zprint.rewrite.sort_val((function (){var G__37598 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__37598) : rewrite_clj.zip.down.call(null,G__37598));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__37601_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__37601_SHARP_) : rewrite_clj.zip.tag.call(null,p1__37601_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__37601_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__37601_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
