...
var G__37149 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__37149__$1 = (((G__37149 == null))?null:cljs.core.iterate((function (loc){
...
var G__37149__$2 = (((G__37149__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__37149__$1));
var G__37149__$3 = (((G__37149__$2 == null))?null:cljs.core.last(G__37149__$2));
if((G__37149__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__37149__$3);
}
} else {
return zloc;
}
...
var G__37171 = rewrite_clj.zip.move.right(v);
var G__37172 = rewrite_clj.zip.move.up(v);
loc = G__37171;
parent = G__37172;
continue;
} else {
var G__37173 = rewrite_clj.zip.move.right(v0);
var G__37174 = parent;
loc = G__37173;
parent = G__37174;
continue;
...
var G__37175 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__37176 = rewrite_clj.zip.move.up(v);
loc = G__37175;
parent = G__37176;
continue;
} else {
var G__37177 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__37178 = parent;
loc = G__37177;
parent = G__37178;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__37166 = zloc;
var G__37166__$1 = (((G__37166 == null))?null:rewrite_clj.zip.move.down(G__37166));
var G__37166__$2 = (((G__37166__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__37166__$1,k));
if((G__37166__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__37166__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__37168 = rewrite_clj.zip.move.down(zloc);
var G__37168__$1 = (((G__37168 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__37168));
if((G__37168__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__37168__$1);
}
})(),k);
}
});
