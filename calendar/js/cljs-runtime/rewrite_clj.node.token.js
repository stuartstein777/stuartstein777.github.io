...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k35798,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k35798,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__35803){
var vec__35804 = p__35803;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35804,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35804,(1),null);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__35797){
var self__ = this;
var G__35797__$1 = this;
return (new cljs.core.RecordIter((0),G__35797__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"string-value","string-value",1109600561)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this35799,other35800){
var self__ = this;
var this35799__$1 = this;
return (((!((other35800 == null)))) && ((((this35799__$1.constructor === other35800.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this35799__$1.value,other35800.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this35799__$1.string_value,other35800.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this35799__$1.__extmap,other35800.__extmap)))))))));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k35798){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k35798);

}
}));

(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__35797){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__35830 = cljs.core.keyword_identical_QMARK_;
var expr__35831 = k__4481__auto__;
if(cljs.core.truth_((pred__35830.cljs$core$IFn$_invoke$arity$2 ? pred__35830.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__35831) : pred__35830.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__35831)))){
return (new rewrite_clj.node.token.TokenNode(G__35797,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__35830.cljs$core$IFn$_invoke$arity$2 ? pred__35830.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__35831) : pred__35830.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__35831)))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__35797,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__35797),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__35797){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__35797,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__35801){
var extmap__4512__auto__ = (function (){var G__35840 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__35801,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
if(cljs.core.record_QMARK_(G__35801)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__35840);
} else {
return G__35840;
}
})();
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__35801),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__35801),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
