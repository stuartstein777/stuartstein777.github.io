...
if((c === "\n")){
var G__36072 = escape_QMARK_;
var G__36073 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__36072;
lines = G__36073;
continue;
} else {
buf.append(c);

var G__36074 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__36075 = lines;
escape_QMARK_ = G__36074;
lines = G__36075;
continue;
...
var G__36069 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__36069) : rewrite_clj.node.string_node.call(null,G__36069));
});
...
var G__36070 = cljs.core.re_pattern(regex);
var G__36071 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__36070,G__36071) : rewrite_clj.node.token_node.call(null,G__36070,G__36071));
});
