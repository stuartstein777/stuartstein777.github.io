...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(month_number,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__29470_SHARP_,new cljs.core.Keyword(null,"date","date",-1463434462)).month());
}),events));
});
...
var holidays = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29477_SHARP_){
return (((module$node_modules$moment$moment().utc() <= p1__29477_SHARP_)) && ((p1__29477_SHARP_ <= end_of_year)));
