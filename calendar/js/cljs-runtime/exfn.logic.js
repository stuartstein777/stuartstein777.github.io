...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__29544_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("Holiday",new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__29544_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29543_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(month_number,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__29543_SHARP_,new cljs.core.Keyword(null,"date","date",-1463434462)).month());
}),events));
});
exfn.logic.events_for_day = (function exfn$logic$events_for_day(events,day){
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29545_SHARP_){
return new cljs.core.Keyword(null,"date","date",-1463434462).cljs$core$IFn$_invoke$arity$1(p1__29545_SHARP_).isSame(day,"day");
}),events);
});
...
var result = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29546_SHARP_){
return new cljs.core.Keyword(null,"date","date",-1463434462).cljs$core$IFn$_invoke$arity$1(p1__29546_SHARP_).isSame(date,"day");
}),events));
return result;
});
...
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29547_SHARP_){
return module$node_modules$moment$moment(cljs.core.str.cljs$core$IFn$_invoke$arity$1(now.clone().add(p1__29547_SHARP_,"days")));
...
var holidays = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29550_SHARP_){
return (((module$node_modules$moment$moment().utc() <= p1__29550_SHARP_)) && ((p1__29550_SHARP_ <= end_of_year)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29549_SHARP_){
return module$node_modules$moment$moment(p1__29549_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"date","date",-1463434462),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29548_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("Holiday",new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__29548_SHARP_));
}),events)))));
