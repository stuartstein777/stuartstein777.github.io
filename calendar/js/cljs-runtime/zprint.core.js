...
var vec__39315 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__39322 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39322,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39322,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39315,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39315,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__39351){
var vec__39352 = p__39351;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39352,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39352,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39356,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39356,(1),null);
...
var vec__39362 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39362,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39362,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39362,(2),null);
var vec__39365 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39365,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39365,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39365,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__39382){
var vec__39383 = p__39382;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39383,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39383,(1),null);
...
var vec__39386 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39386,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39386,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39386,(2),null);
...
var vec__39416 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39416,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39416,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39416,(2),null);
var tuple = vec__39416;
...
var G__39688 = cljs.core.next(style_vec);
var G__39689 = ends_w_blanks_QMARK_;
var G__39690 = tuple;
var G__39691 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__39688;
previous_ends_w_blanks_QMARK_ = G__39689;
previous_tuple = G__39690;
out = G__39691;
continue;
}
break;
...
var len__4829__auto___39692 = arguments.length;
var i__4830__auto___39693 = (0);
while(true){
if((i__4830__auto___39693 < len__4829__auto___39692)){
args__4835__auto__.push((arguments[i__4830__auto___39693]));

var G__39694 = (i__4830__auto___39693 + (1));
i__4830__auto___39693 = G__39694;
continue;
} else {
}
break;
...
var vec__39430 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39430,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39430,(1),null);
...
var result = (function (){var G__39433 = zprint.core.parse_string_all_options(rest_options);
var G__39434 = zprint.core.zprint_str_internal;
var G__39435 = ":parse-string-all? call";
var G__39436 = (function (){var G__39439 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39439) : zprint.zutil.edn_STAR_.call(null,G__39439));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__39433,G__39434,G__39435,G__39436) : zprint.core.process_multiple_forms.call(null,G__39433,G__39434,G__39435,G__39436));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__39444 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39444,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39444,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq39419){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39420,G__39421,seq39419__$2);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___39695 = arguments.length;
var i__4830__auto___39696 = (0);
while(true){
if((i__4830__auto___39696 < len__4829__auto___39695)){
args__4835__auto__.push((arguments[i__4830__auto___39696]));

var G__39697 = (i__4830__auto___39696 + (1));
i__4830__auto___39696 = G__39697;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq39455){
var G__39460 = cljs.core.first(seq39455);
var seq39455__$1 = cljs.core.next(seq39455);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39460,seq39455__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___39716 = arguments.length;
var i__4830__auto___39717 = (0);
while(true){
if((i__4830__auto___39717 < len__4829__auto___39716)){
args__4835__auto__.push((arguments[i__4830__auto___39717]));

var G__39718 = (i__4830__auto___39717 + (1));
i__4830__auto___39717 = G__39718;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq39467){
var G__39468 = cljs.core.first(seq39467);
var seq39467__$1 = cljs.core.next(seq39467);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39468,seq39467__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___39719 = arguments.length;
var i__4830__auto___39720 = (0);
while(true){
if((i__4830__auto___39720 < len__4829__auto___39719)){
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq39480){
var G__39481 = cljs.core.first(seq39480);
var seq39480__$1 = cljs.core.next(seq39480);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39481,seq39480__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___39722 = arguments.length;
var i__4830__auto___39723 = (0);
while(true){
if((i__4830__auto___39723 < len__4829__auto___39722)){
args__4835__auto__.push((arguments[i__4830__auto___39723]));

var G__39724 = (i__4830__auto___39723 + (1));
i__4830__auto___39723 = G__39724;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq39489){
var G__39490 = cljs.core.first(seq39489);
var seq39489__$1 = cljs.core.next(seq39489);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39490,seq39489__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__39506,form){
var vec__39507 = p__39506;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39507,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39507,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39507,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39507,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__39510 = (cljs.core.truth_((function (){var and__4221__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4221__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39510,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39510,(1),null);
...
var G__39747 = cljs.core.next(sos);
var G__39748 = comment_QMARK_;
var G__39749 = (function (){var or__4223__auto__ = (!(empty_string_QMARK_));
if(or__4223__auto__){
return or__4223__auto__;
} else {
...
var G__39750 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__39747;
previous_comment_QMARK_ = G__39748;
start_interpolating_QMARK_ = G__39749;
out = G__39750;
continue;
}
break;
...
try{var vec__39545 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39545,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39545,(1),null);
...
var vec__39548 = (cljs.core.truth_((function (){var or__4223__auto__ = range_start__$1;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39548,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39548,(1),null);
...
var vec__39551 = (cljs.core.truth_((function (){var and__4221__auto__ = actual_start;
if(cljs.core.truth_(and__4221__auto__)){
return actual_end;
} else {
return and__4221__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39551,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39551,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39551,(2),null);
...
var forms = (function (){var G__39569 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39569) : zprint.zutil.edn_STAR_.call(null,G__39569));
})();
