...
var periods__$1 = cljs.core.vec((function (){var G__29765 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29764_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__29764_SHARP_,(0),(3));
}),G__29765);
} else {
return G__29765;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__29784){
var vec__29785 = p__29784;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29785,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29785,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__29788 = pattern;
switch (G__29788) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29788)].join('')));
...
return p1__29789_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__29790_SHARP_){
return p1__29790_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__29791_SHARP_){
return p1__29791_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__29792_SHARP_){
return p1__29792_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__29793_SHARP_){
return p1__29793_SHARP_.getHours();
});

break;
case "day":
return (function (p1__29794_SHARP_){
return p1__29794_SHARP_.getDate();
});

break;
case "month":
return (function (p1__29795_SHARP_){
return p1__29795_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__29796_SHARP_){
return p1__29796_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29797__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__29799){
...
var key = first__29802;
var args = seq__29801__$1;
var G__29803 = key;
...
break;
case "ordinal-suffix":
var vec__29804 = (function (){var G__29807 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__29807) : syntax_list.call(null,G__29807));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29803__$1)].join('')));
...
var d = value;
var G__29811 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__29812 = G__29811;
...
var unparser = first__29814;
var more = seq__29813__$1;
var s = "";
var d__$1 = d;
var G__29811__$1 = G__29811;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__29821 = G__29811__$1;
...
var unparser__$1 = first__29823;
var more__$1 = seq__29822__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__29824 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29824,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29824,(1),null);
var G__29843 = d__$3;
var G__29844 = more__$1;
var G__29845 = s__$3;
d__$1 = G__29843;
G__29811__$1 = G__29844;
s__$1 = G__29845;
continue;
}
break;
