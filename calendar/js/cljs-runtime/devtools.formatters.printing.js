...
var len__4829__auto___28602 = arguments.length;
var i__4830__auto___28603 = (0);
while(true){
if((i__4830__auto___28603 < len__4829__auto___28602)){
args__4835__auto__.push((arguments[i__4830__auto___28603]));

var G__28604 = (i__4830__auto___28603 + (1));
i__4830__auto___28603 = G__28604;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28537){
var G__28538 = cljs.core.first(seq28537);
var seq28537__$1 = cljs.core.next(seq28537);
var G__28539 = cljs.core.first(seq28537__$1);
var seq28537__$2 = cljs.core.next(seq28537__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28538,G__28539,seq28537__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28576_SHARP_){
return (!((cljs.core.meta(p1__28576_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28582__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28583){var _e__27835__auto__ = e28583;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e28585){var _e__27835__auto__ = e28585;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28590 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28591 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28591);

try{var map__28592 = opts;
var map__28592__$1 = cljs.core.__destructure_map(map__28592);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28592__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28590);
}});
...
var temp__5751__auto___28621 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___28621)){
var managed_print_level_28622 = temp__5751__auto___28621;
var _STAR_print_level_STAR__orig_val__28595_28625 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28596_28626 = managed_print_level_28622;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28596_28626);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28593_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28593_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28595_28625);
}} else {
job_fn();
}
