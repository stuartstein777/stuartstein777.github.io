...
var G__36102 = clojure.zip.node(loc);
var fexpr__36101 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__36101.cljs$core$IFn$_invoke$arity$1 ? fexpr__36101.cljs$core$IFn$_invoke$arity$1(G__36102) : fexpr__36101.call(null,G__36102));
});
/**
...
var G__36105 = clojure.zip.node(loc);
var fexpr__36104 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__36104.cljs$core$IFn$_invoke$arity$1 ? fexpr__36104.cljs$core$IFn$_invoke$arity$1(G__36105) : fexpr__36104.call(null,G__36105));
} else {
...
var fexpr__36110 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__36110.cljs$core$IFn$_invoke$arity$2 ? fexpr__36110.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__36110.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__36123 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36123,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36123,(1),null);
var vec__36126 = clojure.zip.children(loc);
...
var vec__36133 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36133,(0),null);
var map__36136 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36133,(1),null);
var map__36136__$1 = cljs.core.__destructure_map(map__36136);
var path = map__36136__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36136__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36136__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36136__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36136__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36136__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__36144 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36144,(0),null);
var map__36147 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36144,(1),null);
var map__36147__$1 = cljs.core.__destructure_map(map__36147);
var path = map__36147__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36147__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__36148 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36147__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__36152 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36152,(0),null);
...
var path = map__36155__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36155__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36155__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return r;
} else {
...
var vec__36159 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36159,(0),null);
var map__36162 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36159,(1),null);
var map__36162__$1 = cljs.core.__destructure_map(map__36162);
var path = map__36162__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36162__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36162__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
...
var vec__36166 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36166,(0),null);
var map__36169 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36166,(1),null);
var map__36169__$1 = cljs.core.__destructure_map(map__36169);
var path = map__36169__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36169__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36169__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__36180 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36180,(0),null);
...
var path = map__36183__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36183__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__36190 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36190,(0),null);
var map__36193 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36190,(1),null);
var map__36193__$1 = cljs.core.__destructure_map(map__36193);
var path = map__36193__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36193__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__36204 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36204,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36204,(1),null);
...
var len__4829__auto___36255 = arguments.length;
var i__4830__auto___36256 = (0);
while(true){
if((i__4830__auto___36256 < len__4829__auto___36255)){
args__4835__auto__.push((arguments[i__4830__auto___36256]));

var G__36257 = (i__4830__auto___36256 + (1));
i__4830__auto___36256 = G__36257;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq36207){
var G__36208 = cljs.core.first(seq36207);
var seq36207__$1 = cljs.core.next(seq36207);
var G__36209 = cljs.core.first(seq36207__$1);
var seq36207__$2 = cljs.core.next(seq36207__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36208,G__36209,seq36207__$2);
}));
...
var G__36261 = clojure.zip.rightmost(child);
loc__$1 = G__36261;
continue;
} else {
return loc__$1;
...
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36232__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36232__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36232__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__36268 = clojure.zip.rightmost(child);
loc__$1 = G__36268;
continue;
} else {
return loc__$1;
