...
return [(function (){var pred__38687 = cljs.core.instance_QMARK_;
var expr__38688 = reactive_val;
if(cljs.core.truth_((pred__38687.cljs$core$IFn$_invoke$arity$2 ? pred__38687.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__38688) : pred__38687.call(null,reagent.ratom.RAtom,expr__38688)))){
return "ra";
} else {
if(cljs.core.truth_((pred__38687.cljs$core$IFn$_invoke$arity$2 ? pred__38687.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__38688) : pred__38687.call(null,reagent.ratom.RCursor,expr__38688)))){
return "rc";
} else {
if(cljs.core.truth_((pred__38687.cljs$core$IFn$_invoke$arity$2 ? pred__38687.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__38688) : pred__38687.call(null,reagent.ratom.Reaction,expr__38688)))){
return "rx";
} else {
if(cljs.core.truth_((pred__38687.cljs$core$IFn$_invoke$arity$2 ? pred__38687.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__38688) : pred__38687.call(null,reagent.ratom.Track,expr__38688)))){
return "tr";
} else {
return "other";
}
