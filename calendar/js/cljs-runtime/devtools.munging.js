...
var o28044 = temp__5751__auto__;
var temp__5751__auto____$1 = (o28044["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o28045 = temp__5751__auto____$1;
return (o28045["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27823__auto__ = f;
return (o__27823__auto__["toString"]).call(o__27823__auto__);
} else {
return "";
}
...
try{var o__27823__auto___28372 = t;
(o__27823__auto___28372["cljs$lang$ctorPrWriter"]).call(o__27823__auto___28372,t,writer);
}catch (e28063){var __28373 = e28063;
}
...
var char_code = (function (){var o__27823__auto__ = (new String(char$));
return (o__27823__auto__["charCodeAt"]).call(o__27823__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27823__auto__ = String;
return (o__27823__auto__["fromCharCode"]).call(o__27823__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28076 = num_code;
switch (G__28076) {
case (1):
return (185);
...
var o__27823__auto__ = String;
return (o__27823__auto__["fromCharCode"]).call(o__27823__auto__,superscript_code);
});
/**
...
}catch (e28112){var _e__27835__auto__ = e28112;
return false;
}})())){
...
var vec__28120 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28120,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var o28135 = temp__5751__auto__;
var temp__5751__auto____$1 = (o28135["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o28136 = temp__5751__auto____$1;
return (o28136["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4829__auto___28384 = arguments.length;
var i__4830__auto___28385 = (0);
while(true){
if((i__4830__auto___28385 < len__4829__auto___28384)){
args__4835__auto__.push((arguments[i__4830__auto___28385]));

var G__28388 = (i__4830__auto___28385 + (1));
i__4830__auto___28385 = G__28388;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28139){
var vec__28140 = p__28139;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28140,(0),null);
...
var G__28392 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28393 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28392;
remaining_tokens = G__28393;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28137){
var G__28138 = cljs.core.first(seq28137);
var seq28137__$1 = cljs.core.next(seq28137);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28138,seq28137__$1);
}));
...
var vec__28147 = cljs.core.split_with((function (p1__28146_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28146_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28147,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28147,(1),null);
...
var vec__28154 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28154,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28154,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28401 = cljs.core.rest(remaining_tokens);
var G__28402 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28401;
name_tokens = G__28402;
continue;
} else {
...
var vec__28162 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28162,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28162,(1),null);
var vec__28165 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28165,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28165,(1),null);
var vec__28168 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28168,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28168,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28168,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28168,(3),null);
...
var vec__28175 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28175,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28175,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28175,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28175,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28175,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28175,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__28183 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28183,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28183,(1),null);
var vec__28186 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28186,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28186,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28191 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28191) : devtools.munging.parse_fn_info_deep.call(null,G__28191));
})()));
}
} else {
return fn_info;
...
var G__28426 = (arity + (1));
var G__28427 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28231){
var vec__28232 = p__28231;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28232,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28232,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28244_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28244_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28245_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28245_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___28432 = arguments.length;
var i__4830__auto___28433 = (0);
while(true){
if((i__4830__auto___28433 < len__4829__auto___28432)){
args__4835__auto__.push((arguments[i__4830__auto___28433]));

var G__28434 = (i__4830__auto___28433 + (1));
i__4830__auto___28433 = G__28434;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28258){
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28250){
var G__28251 = cljs.core.first(seq28250);
var seq28250__$1 = cljs.core.next(seq28250);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28251,seq28250__$1);
}));
...
var map__28273 = options;
var map__28273__$1 = cljs.core.__destructure_map(map__28273);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28273__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28273__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28273__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28273__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28274 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28274,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28274,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28274,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28274,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28274,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28274,(5),null);
...
var o__27823__auto__ = f;
return (o__27823__auto__["getBasis"]).call(o__27823__auto__);
});
/**
...
}catch (e28290){var _e__27835__auto__ = e28290;
...
var G__28454 = (obj[cljs.core.first(path)]);
var G__28455 = cljs.core.rest(path);
obj = G__28454;
path = G__28455;
continue;
} else {
...
var _STAR_ = (function (accum,p__28313){
var vec__28315 = p__28313;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28315,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28315,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28325){
var vec__28326 = p__28325;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28326,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28326,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28326,(2),null);
...
var post_process = (function (p__28348){
var vec__28349 = p__28348;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28349,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28349,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28340_SHARP_){
return (obj[cljs.core.first(p1__28340_SHARP_)]);
}),sorted_matches);
