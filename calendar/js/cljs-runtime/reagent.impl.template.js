...
var G__38360 = o;
goog.object.set(G__38360,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__38436__delegate = function (args){
...
while (G__38437__i < G__38437__a.length) {G__38437__a[G__38437__i] = arguments[G__38437__i + 0]; ++G__38437__i;}
  args = new cljs.core.IndexedSeq(G__38437__a,0,null);
} 
return G__38436__delegate.call(this,args);};
G__38436.cljs$lang$maxFixedArity = 0;
G__38436.cljs$lang$applyTo = (function (arglist__38438){
var args = cljs.core.seq(arglist__38438);
return G__38436__delegate(args);
});
...
var G__38364 = o;
goog.object.set(G__38364,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__38365 = props;
var G__38365__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38365,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38365);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38365__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38366 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38366,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38366;
}
})(),id_class);
...
var G__38369 = (cljs.core.count(argv) - first_child);
switch (G__38369) {
case (0):
...
var vec__38387 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38387,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38387,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38387,(2),null);
...
var temp__5757__auto___38450 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___38450 == null)){
} else {
var key_38452 = temp__5757__auto___38450;
(jsprops.key = key_38452);
}
...
var temp__5757__auto___38456 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___38456 == null)){
} else {
var key_38457 = temp__5757__auto___38456;
(jsprops.key = key_38457);
}
...
var temp__5757__auto___38458 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___38458 == null)){
} else {
var key_38459 = temp__5757__auto___38458;
...
var temp__5757__auto___38467 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38467 == null)){
} else {
var key_38468 = temp__5757__auto___38467;
(jsprops.key = key_38468);
}
...
var temp__5757__auto___38470 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38470 == null)){
} else {
var key_38471 = temp__5757__auto___38470;
(jsprops.key = key_38471);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38390_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38390_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38391 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38391,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38391,(1),null);
...
break;
default:
var G__38477 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38478 = compiler;
v = G__38477;
compiler = G__38478;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template38412 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template38412 = (function (opts,id,fn_to_element,meta38413){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38412.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38414,meta38413__$1){
var self__ = this;
var _38414__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38412(self__.opts,self__.id,self__.fn_to_element,meta38413__$1));
}));

(reagent.impl.template.t_reagent$impl$template38412.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38414){
var self__ = this;
var _38414__$1 = this;
return self__.meta38413;
}));

(reagent.impl.template.t_reagent$impl$template38412.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38412.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38412.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38412.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38412.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta38413","meta38413",148872835,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38412.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38412.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38412");

(reagent.impl.template.t_reagent$impl$template38412.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template38412");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38412.
 */
reagent.impl.template.__GT_t_reagent$impl$template38412 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template38412(opts__$1,id__$1,fn_to_element__$1,meta38413){
return (new reagent.impl.template.t_reagent$impl$template38412(opts__$1,id__$1,fn_to_element__$1,meta38413));
});

}

return (new reagent.impl.template.t_reagent$impl$template38412(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
