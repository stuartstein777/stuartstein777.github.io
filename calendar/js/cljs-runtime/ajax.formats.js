...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__43972){
var map__43974 = p__43972;
var map__43974__$1 = cljs.core.__destructure_map(map__43974);
var request = map__43974__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43974__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__43983 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__43983.cljs$core$IFn$_invoke$arity$1 ? fexpr__43983.cljs$core$IFn$_invoke$arity$1(response) : fexpr__43983.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__43984 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__43984.cljs$core$IFn$_invoke$arity$1 ? fexpr__43984.cljs$core$IFn$_invoke$arity$1(response) : fexpr__43984.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__43986){
var map__43987 = p__43986;
var map__43987__$1 = cljs.core.__destructure_map(map__43987);
var request = map__43987__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43987__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
