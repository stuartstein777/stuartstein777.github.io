...
var G__36460 = (function (){var G__36461 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__36461) : f.call(null,G__36461));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__36460) : rewrite_clj.node.coerce.call(null,G__36460));
});
/**
...
var len__4829__auto___36500 = arguments.length;
var i__4830__auto___36502 = (0);
while(true){
if((i__4830__auto___36502 < len__4829__auto___36500)){
args__4835__auto__.push((arguments[i__4830__auto___36502]));

var G__36503 = (i__4830__auto___36502 + (1));
i__4830__auto___36502 = G__36503;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__36466_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__36466_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq36467){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36468,G__36469,seq36467__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__36482 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__36482) : str_fn.call(null,G__36482));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__36483 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__36483) : str_fn.call(null,G__36483));
})()):null)));
...
var G__36492 = rewrite_clj.zip.base.tag(zloc);
var G__36492__$1 = (((G__36492 instanceof cljs.core.Keyword))?G__36492.fqn:null);
switch (G__36492__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__36489_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__36489_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__36490_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__36490_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36492__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__36496 = rewrite_clj.zip.base.tag(zloc);
var G__36496__$1 = (((G__36496 instanceof cljs.core.Keyword))?G__36496.fqn:null);
switch (G__36496__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__36495_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__36495_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36496__$1)].join('')));
