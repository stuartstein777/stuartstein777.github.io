 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__32842,right){
var map__32843 = p__32842;
var map__32843__$1 = cljs.core.__destructure_map(map__32843);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32843__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32843__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__32874 = temp__5753__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32874,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32874,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32874,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32897__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__32898 = u(y);
var map__32898__$1 = cljs.core.__destructure_map(map__32898);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32898__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__32956__delegate = function (x,y,more){
...
var G__32956 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__32958__i = 0, G__32958__a = new Array(arguments.length -  2);
while (G__32958__i < G__32958__a.length) {G__32958__a[G__32958__i] = arguments[G__32958__i + 2]; ++G__32958__i;}
  more = new cljs.core.IndexedSeq(G__32958__a,0,null);
} 
return G__32956__delegate.call(this,x,y,more);};
G__32956.cljs$lang$maxFixedArity = 2;
G__32956.cljs$lang$applyTo = (function (arglist__32959){
var x = cljs.core.first(arglist__32959);
arglist__32959 = cljs.core.next(arglist__32959);
var y = cljs.core.first(arglist__32959);
var more = cljs.core.rest(arglist__32959);
return G__32956__delegate(x,y,more);
});
...
var G__32960 = null;
if (arguments.length > 2) {
var G__32961__i = 0, G__32961__a = new Array(arguments.length -  2);
while (G__32961__i < G__32961__a.length) {G__32961__a[G__32961__i] = arguments[G__32961__i + 2]; ++G__32961__i;}
G__32960 = new cljs.core.IndexedSeq(G__32961__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__32960);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32905__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__32906 = u(y);
var map__32906__$1 = cljs.core.__destructure_map(map__32906);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32906__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__32963__delegate = function (x,y,more){
...
var G__32963 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__32964__i = 0, G__32964__a = new Array(arguments.length -  2);
while (G__32964__i < G__32964__a.length) {G__32964__a[G__32964__i] = arguments[G__32964__i + 2]; ++G__32964__i;}
  more = new cljs.core.IndexedSeq(G__32964__a,0,null);
} 
return G__32963__delegate.call(this,x,y,more);};
G__32963.cljs$lang$maxFixedArity = 2;
...
return G__32963__delegate(x,y,more);
});
...
var G__32966 = null;
if (arguments.length > 2) {
var G__32967__i = 0, G__32967__a = new Array(arguments.length -  2);
while (G__32967__i < G__32967__a.length) {G__32967__a[G__32967__i] = arguments[G__32967__i + 2]; ++G__32967__i;}
G__32966 = new cljs.core.IndexedSeq(G__32967__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__32966);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__32913 = u(x);
var map__32913__$1 = cljs.core.__destructure_map(map__32913);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32913__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__32914 = u(y);
var map__32914__$1 = cljs.core.__destructure_map(map__32914);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32914__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__32968__delegate = function (x,y,more){
...
var G__32968 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__32971__i = 0, G__32971__a = new Array(arguments.length -  2);
while (G__32971__i < G__32971__a.length) {G__32971__a[G__32971__i] = arguments[G__32971__i + 2]; ++G__32971__i;}
  more = new cljs.core.IndexedSeq(G__32971__a,0,null);
} 
return G__32968__delegate.call(this,x,y,more);};
G__32968.cljs$lang$maxFixedArity = 2;
G__32968.cljs$lang$applyTo = (function (arglist__32972){
var x = cljs.core.first(arglist__32972);
arglist__32972 = cljs.core.next(arglist__32972);
var y = cljs.core.first(arglist__32972);
var more = cljs.core.rest(arglist__32972);
return G__32968__delegate(x,y,more);
});
...
G__32973 = new cljs.core.IndexedSeq(G__32974__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__32973);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32915__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__32916 = u(y);
var map__32916__$1 = cljs.core.__destructure_map(map__32916);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32916__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__32980__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__32983__i = 0, G__32983__a = new Array(arguments.length -  2);
while (G__32983__i < G__32983__a.length) {G__32983__a[G__32983__i] = arguments[G__32983__i + 2]; ++G__32983__i;}
  more = new cljs.core.IndexedSeq(G__32983__a,0,null);
} 
return G__32980__delegate.call(this,x,y,more);};
G__32980.cljs$lang$maxFixedArity = 2;
G__32980.cljs$lang$applyTo = (function (arglist__32984){
var x = cljs.core.first(arglist__32984);
arglist__32984 = cljs.core.next(arglist__32984);
var y = cljs.core.first(arglist__32984);
var more = cljs.core.rest(arglist__32984);
...
var G__32985 = null;
if (arguments.length > 2) {
var G__32986__i = 0, G__32986__a = new Array(arguments.length -  2);
while (G__32986__i < G__32986__a.length) {G__32986__a[G__32986__i] = arguments[G__32986__i + 2]; ++G__32986__i;}
G__32985 = new cljs.core.IndexedSeq(G__32986__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__32985);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
