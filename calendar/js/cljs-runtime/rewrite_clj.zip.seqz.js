...
var G__36526 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__36526__$1 = (((G__36526 == null))?null:cljs.core.iterate((function (loc){
...
var G__36526__$2 = (((G__36526__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__36526__$1));
var G__36526__$3 = (((G__36526__$2 == null))?null:cljs.core.last(G__36526__$2));
if((G__36526__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__36526__$3);
}
} else {
return zloc;
}
...
var G__36540 = rewrite_clj.zip.move.right(v);
var G__36541 = rewrite_clj.zip.move.up(v);
loc = G__36540;
parent = G__36541;
continue;
} else {
var G__36542 = rewrite_clj.zip.move.right(v0);
var G__36543 = parent;
loc = G__36542;
parent = G__36543;
continue;
...
var G__36544 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__36545 = rewrite_clj.zip.move.up(v);
loc = G__36544;
parent = G__36545;
continue;
} else {
var G__36546 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__36547 = parent;
loc = G__36546;
parent = G__36547;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__36536 = zloc;
var G__36536__$1 = (((G__36536 == null))?null:rewrite_clj.zip.move.down(G__36536));
var G__36536__$2 = (((G__36536__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__36536__$1,k));
if((G__36536__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__36536__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__36537 = rewrite_clj.zip.move.down(zloc);
var G__36537__$1 = (((G__36537 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__36537));
if((G__36537__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__36537__$1);
}
})(),k);
}
});
