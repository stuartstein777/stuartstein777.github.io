...
var G__37240 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__37240;
continue;
} else {
var G__37243 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__37243;
continue;
}
} else {
var G__37244 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__37244;
continue;
}
}
...
var G__37200 = zloc;
var G__37201 = (function (){var G__37202 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__37205 = zloc;
var G__37205__$1 = (((G__37205 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__37205) : rewrite_clj.zip.node.call(null,G__37205)));
if((G__37205__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__37205__$1) : zprint.zutil.edn_STAR_.call(null,G__37205__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__37202) : rewrite_clj.zip.root.call(null,G__37202));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__37200,G__37201) : rewrite_clj.zip.replace.call(null,G__37200,G__37201));
});
/**
...
var G__37267 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__37267;
continue;
}
break;
...
var G__37268 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__37269 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__37268;
out = G__37269;
continue;
} else {
...
var G__37272 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__37273 = cljs.core.next(new_loc);
var G__37274 = replaced_loc;
nloc = G__37272;
new_loc = G__37273;
last_loc = G__37274;
continue;
...
return zprint.rewrite.sort_val((function (){var G__37220 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__37220) : rewrite_clj.zip.down.call(null,G__37220));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__37224_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__37224_SHARP_) : rewrite_clj.zip.tag.call(null,p1__37224_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__37224_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__37224_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
