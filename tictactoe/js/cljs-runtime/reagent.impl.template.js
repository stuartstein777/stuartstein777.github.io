...
var G__38422 = o;
goog.object.set(G__38422,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__38527__i < G__38527__a.length) {G__38527__a[G__38527__i] = arguments[G__38527__i + 0]; ++G__38527__i;}
  args = new cljs.core.IndexedSeq(G__38527__a,0,null);
} 
...
var G__38433 = o;
goog.object.set(G__38433,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__38445 = props;
var G__38445__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38445,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38445);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38445__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38452 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38452,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38452;
}
})(),id_class);
...
var G__38457 = (cljs.core.count(argv) - first_child);
switch (G__38457) {
case (0):
...
var vec__38467 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38467,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38467,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38467,(2),null);
...
var temp__5739__auto___38533 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___38533 == null)){
} else {
var key_38534 = temp__5739__auto___38533;
(jsprops.key = key_38534);
}
...
var temp__5739__auto___38541 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___38541 == null)){
} else {
var key_38542 = temp__5739__auto___38541;
(jsprops.key = key_38542);
}
...
var temp__5739__auto___38543 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___38543 == null)){
} else {
var key_38544 = temp__5739__auto___38543;
(jsprops.key = key_38544);
}
...
var temp__5739__auto___38549 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___38549 == null)){
} else {
var key_38550 = temp__5739__auto___38549;
(jsprops.key = key_38550);
}
...
var temp__5739__auto___38552 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___38552 == null)){
} else {
var key_38554 = temp__5739__auto___38552;
(jsprops.key = key_38554);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38481_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38481_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38485 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38485,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38485,(1),null);
...
break;
default:
var G__38563 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38564 = compiler;
v = G__38563;
compiler = G__38564;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template38512 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template38512 = (function (opts,id,fn_to_element,meta38513){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38512.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38514,meta38513__$1){
var self__ = this;
var _38514__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38512(self__.opts,self__.id,self__.fn_to_element,meta38513__$1));
}));

(reagent.impl.template.t_reagent$impl$template38512.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38514){
var self__ = this;
var _38514__$1 = this;
return self__.meta38513;
}));

(reagent.impl.template.t_reagent$impl$template38512.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38512.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38512.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38512.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38512.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta38513","meta38513",431085077,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38512.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38512.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38512");

(reagent.impl.template.t_reagent$impl$template38512.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template38512");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38512.
 */
reagent.impl.template.__GT_t_reagent$impl$template38512 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template38512(opts__$1,id__$1,fn_to_element__$1,meta38513){
return (new reagent.impl.template.t_reagent$impl$template38512(opts__$1,id__$1,fn_to_element__$1,meta38513));
});

}

return (new reagent.impl.template.t_reagent$impl$template38512(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
