...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38135 = c;
var G__38135__$1 = (((G__38135 == null))?null:G__38135.prototype);
if((G__38135__$1 == null)){
return null;
} else {
return G__38135__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38145 = c;
var G__38145__$1 = (((G__38145 == null))?null:G__38145.prototype);
if((G__38145__$1 == null)){
return null;
} else {
return G__38145__$1.render;
}
})() == null)))));
});
...
var or__4126__auto__ = (function (){var G__38176 = c;
var G__38176__$1 = (((G__38176 == null))?null:G__38176.constructor);
if((G__38176__$1 == null)){
return null;
} else {
return G__38176__$1.displayName;
}
})();
...
var G__38177 = c;
var G__38177__$1 = (((G__38177 == null))?null:G__38177.constructor);
if((G__38177__$1 == null)){
return null;
} else {
return G__38177__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38187 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38188 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38188);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38187);
}});
...
var c = this;
var G__38234_38357 = goog.object.get(c,"cljsRatom");
if((G__38234_38357 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38234_38357);
}
...
var renders_38362 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_38363 = cljs.core.first(cljs.core.vals(renders_38362));
...
if((cljs.core.count(renders_38362) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38362))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38363)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38363], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38297 = o;
goog.object.set(G__38297,cljs.core.name(k),v);
...
return (function() { 
var G__38376__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__38377__i < G__38377__a.length) {G__38377__a[G__38377__i] = arguments[G__38377__i + 0]; ++G__38377__i;}
  args = new cljs.core.IndexedSeq(G__38377__a,0,null);
} 
return G__38376__delegate.call(this,args);};
...
return G__38376__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__38303 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38304 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38304);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38303);
}});
...
var vec__38312 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38312,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38312,(1),null);
...
var G__38317 = goog.object.get(reagent_state,"cljsRatom");
if((G__38317 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__38317);
}
});
}),[]);
