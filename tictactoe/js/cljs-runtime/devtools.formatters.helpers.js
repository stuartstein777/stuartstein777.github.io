...
var G__28242 = devtools.prefs.pref(v);
v = G__28242;
continue;
} else {
return v;
...
}catch (e28163){var _e__27752__auto__ = e28163;
return false;
}})();
...
}catch (e28169){var _e__27752__auto__ = e28169;
return false;
}})();
...
}catch (e28173){var _e__27752__auto__ = e28173;
return false;
}}
}
});
...
var vec__28188 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28188,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28188,(1),null);
...
return cljs.core.some((function (p1__28196_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28196_SHARP_);
}),template);
});
