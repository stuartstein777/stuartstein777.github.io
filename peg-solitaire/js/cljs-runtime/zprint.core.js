...
var vec__39939 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__39942 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39942,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39942,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39939,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39939,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__39959){
var vec__39960 = p__39959;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39960,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39960,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39964,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39964,(1),null);
...
var vec__39985 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39985,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39985,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39985,(2),null);
var vec__39988 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39988,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39988,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39988,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__39999){
var vec__40000 = p__39999;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40000,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40000,(1),null);
...
var vec__40003 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40003,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40003,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40003,(2),null);
...
var vec__40015 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40015,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40015,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40015,(2),null);
var tuple = vec__40015;
...
var G__40298 = cljs.core.next(style_vec);
var G__40299 = ends_w_blanks_QMARK_;
var G__40300 = tuple;
var G__40301 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__40298;
previous_ends_w_blanks_QMARK_ = G__40299;
previous_tuple = G__40300;
out = G__40301;
continue;
}
break;
...
var len__4736__auto___40302 = arguments.length;
var i__4737__auto___40303 = (0);
while(true){
if((i__4737__auto___40303 < len__4736__auto___40302)){
args__4742__auto__.push((arguments[i__4737__auto___40303]));

var G__40304 = (i__4737__auto___40303 + (1));
i__4737__auto___40303 = G__40304;
continue;
} else {
}
break;
...
var vec__40026 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40026,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40026,(1),null);
...
var result = (function (){var G__40030 = zprint.core.parse_string_all_options(rest_options);
var G__40031 = zprint.core.zprint_str_internal;
var G__40032 = ":parse-string-all? call";
var G__40033 = (function (){var G__40034 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__40034) : zprint.zutil.edn_STAR_.call(null,G__40034));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__40030,G__40031,G__40032,G__40033) : zprint.core.process_multiple_forms.call(null,G__40030,G__40031,G__40032,G__40033));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__40036 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40036,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40036,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq40022){
var G__40023 = cljs.core.first(seq40022);
var seq40022__$1 = cljs.core.next(seq40022);
var G__40024 = cljs.core.first(seq40022__$1);
var seq40022__$2 = cljs.core.next(seq40022__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40023,G__40024,seq40022__$2);
}));
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq40045){
var G__40046 = cljs.core.first(seq40045);
var seq40045__$1 = cljs.core.next(seq40045);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40046,seq40045__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___40312 = arguments.length;
var i__4737__auto___40313 = (0);
while(true){
if((i__4737__auto___40313 < len__4736__auto___40312)){
args__4742__auto__.push((arguments[i__4737__auto___40313]));

var G__40314 = (i__4737__auto___40313 + (1));
i__4737__auto___40313 = G__40314;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq40061){
var G__40062 = cljs.core.first(seq40061);
var seq40061__$1 = cljs.core.next(seq40061);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40062,seq40061__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___40315 = arguments.length;
var i__4737__auto___40316 = (0);
while(true){
if((i__4737__auto___40316 < len__4736__auto___40315)){
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq40071){
var G__40072 = cljs.core.first(seq40071);
var seq40071__$1 = cljs.core.next(seq40071);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40072,seq40071__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq40081){
var G__40082 = cljs.core.first(seq40081);
var seq40081__$1 = cljs.core.next(seq40081);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40082,seq40081__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__40116,form){
var vec__40117 = p__40116;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40117,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40117,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40117,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40117,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__40120 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40120,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40120,(1),null);
...
var G__40325 = cljs.core.next(sos);
var G__40326 = comment_QMARK_;
var G__40327 = (function (){var or__4126__auto__ = (!(empty_string_QMARK_));
if(or__4126__auto__){
return or__4126__auto__;
} else {
...
var G__40328 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__40325;
previous_comment_QMARK_ = G__40326;
start_interpolating_QMARK_ = G__40327;
out = G__40328;
continue;
}
break;
...
try{var vec__40166 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40166,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40166,(1),null);
...
var vec__40169 = (cljs.core.truth_((function (){var or__4126__auto__ = range_start__$1;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40169,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40169,(1),null);
...
var vec__40172 = (cljs.core.truth_((function (){var and__4115__auto__ = actual_start;
if(cljs.core.truth_(and__4115__auto__)){
return actual_end;
} else {
return and__4115__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40172,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40172,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40172,(2),null);
...
var forms = (function (){var G__40204 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__40204) : zprint.zutil.edn_STAR_.call(null,G__40204));
})();
