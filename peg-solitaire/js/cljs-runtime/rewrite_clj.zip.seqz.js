...
var G__37159 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__37159__$1 = (((G__37159 == null))?null:cljs.core.iterate((function (loc){
...
var G__37159__$2 = (((G__37159__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__37159__$1));
var G__37159__$3 = (((G__37159__$2 == null))?null:cljs.core.last(G__37159__$2));
if((G__37159__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__37159__$3);
}
} else {
return zloc;
}
...
var G__37179 = rewrite_clj.zip.move.right(v);
var G__37180 = rewrite_clj.zip.move.up(v);
loc = G__37179;
parent = G__37180;
continue;
} else {
var G__37181 = rewrite_clj.zip.move.right(v0);
var G__37182 = parent;
loc = G__37181;
parent = G__37182;
continue;
...
var G__37183 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__37184 = rewrite_clj.zip.move.up(v);
loc = G__37183;
parent = G__37184;
continue;
} else {
var G__37185 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__37186 = parent;
loc = G__37185;
parent = G__37186;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__37174 = zloc;
var G__37174__$1 = (((G__37174 == null))?null:rewrite_clj.zip.move.down(G__37174));
var G__37174__$2 = (((G__37174__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__37174__$1,k));
if((G__37174__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__37174__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__37176 = rewrite_clj.zip.move.down(zloc);
var G__37176__$1 = (((G__37176 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__37176));
if((G__37176__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__37176__$1);
}
})(),k);
}
});
