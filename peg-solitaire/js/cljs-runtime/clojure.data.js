...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__27060){
...
var vec__27067 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27067,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27067,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27067,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_27258 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_27258(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_27267 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_27267(a,b);
}
});
...
var fexpr__27186 = (function (){var G__27188 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27188__$1)].join('')));

}
})();
return (fexpr__27186.cljs$core$IFn$_invoke$arity$2 ? fexpr__27186.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__27186.call(null,a,b));
}));
/**
