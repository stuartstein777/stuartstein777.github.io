...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__35376_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__35376_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__35376_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__35377){
var vec__35378 = p__35377;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35378,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35378,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__35383,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35384__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35384__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35384__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__35389 = (function (){var or__4126__auto__ = color;
...
var fexpr__35388 = (function (){var G__35391 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__35391) : style_map.call(null,G__35391));
})();
return (fexpr__35388.cljs$core$IFn$_invoke$arity$1 ? fexpr__35388.cljs$core$IFn$_invoke$arity$1(G__35389) : fexpr__35388.call(null,G__35389));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__35392){
var vec__35393 = p__35392;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35393,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35393,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35393,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__35396){
var vec__35397 = p__35396;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35397,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35397,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35397,(2),null);
...
var G__35596 = cljs.core.next(ssv);
var G__35597 = (this_ssv == null);
var G__35598 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__35599 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__35596;
doing_nil_QMARK_ = G__35597;
last_elide = G__35598;
out = G__35599;
continue;
}
...
var vec__35413 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35413,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35413,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35413,(2),null);
...
var G__35602 = cljs.core.next(remaining_cvec);
var G__35603 = new_idx;
var G__35604 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__35602;
idx = G__35603;
out = G__35604;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__35431,cursor_vec){
var vec__35433 = p__35431;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35433,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35433,(1),null);
var focus_vec = vec__35433;
...
var vec__35438 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35438,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35438,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__35443){
var vec__35444 = p__35443;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35444,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35444,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__35454,existing_count){
var vec__35456 = p__35454;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35456,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35456,(1),null);
...
return cljs.core.filterv((function (p1__35450_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__35450_SHARP_))));
...
var vec__35497 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35497,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35497,(1),null);
var cvec_element = vec__35497;
if((cvec_element == null)){
var G__35625 = cljs.core.next(cvec_nl);
var G__35626 = (idx + (1));
var G__35627 = start;
var G__35628 = out;
cvec_nl = G__35625;
...
var G__35629 = cljs.core.next(cvec_nl);
var G__35630 = (idx + (1));
var G__35631 = idx;
var G__35632 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__35629;
idx = G__35630;
start = G__35631;
out = G__35632;
...
var G__35634 = cljs.core.next(cvec_nl);
var G__35635 = (idx + (1));
var G__35636 = (idx + (1));
var G__35637 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__35634;
idx = G__35635;
start = G__35636;
out = G__35637;
...
var G__35638 = cljs.core.next(cvec_nl);
var G__35639 = (idx + (1));
var G__35640 = idx;
var G__35641 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__35638;
idx = G__35639;
start = G__35640;
out = G__35641;
...
var G__35642 = cljs.core.next(cvec_nl);
var G__35643 = (idx + (1));
var G__35644 = start;
var G__35645 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__35642;
idx = G__35643;
start = G__35644;
out = G__35645;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__35517_SHARP_,p2__35516_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__35516_SHARP_)){
return cljs.core.reduced(p1__35517_SHARP_);
} else {
return (p1__35517_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__35532,p__35533){
var vec__35534 = p__35532;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35534,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35534,(1),null);
var vec__35537 = p__35533;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35537,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35537,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__35571,cvec,focus_vec){
...
var options = map__35572__$1;
var map__35573 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35572__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35573__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35573__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35573__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35569_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__35569_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
