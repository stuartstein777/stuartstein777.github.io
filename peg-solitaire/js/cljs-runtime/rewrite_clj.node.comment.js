...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k35742,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k35742,else__4383__auto__);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__35741){
var self__ = this;
var G__35741__$1 = this;
return (new cljs.core.RecordIter((0),G__35741__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this35743,other35744){
var self__ = this;
var this35743__$1 = this;
return (((!((other35744 == null)))) && ((this35743__$1.constructor === other35744.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this35743__$1.s,other35744.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this35743__$1.__extmap,other35744.__extmap)));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__35741){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__35802 = cljs.core.keyword_identical_QMARK_;
var expr__35803 = k__4388__auto__;
if(cljs.core.truth_((pred__35802.cljs$core$IFn$_invoke$arity$2 ? pred__35802.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__35803) : pred__35802.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__35803)))){
return (new rewrite_clj.node.comment.CommentNode(G__35741,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__35741),null));
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__35741){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.s,G__35741,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__35745){
var extmap__4419__auto__ = (function (){var G__35835 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__35745,new cljs.core.Keyword(null,"s","s",1705939918));
if(cljs.core.record_QMARK_(G__35745)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__35835);
} else {
return G__35835;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__35745),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
