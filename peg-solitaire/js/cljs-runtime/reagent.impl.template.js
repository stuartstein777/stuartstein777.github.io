...
var G__39007 = o;
goog.object.set(G__39007,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__39064__delegate = function (args){
...
return G__39064__delegate.call(this,args);};
G__39064.cljs$lang$maxFixedArity = 0;
G__39064.cljs$lang$applyTo = (function (arglist__39067){
var args = cljs.core.seq(arglist__39067);
return G__39064__delegate(args);
});
...
var G__39014 = o;
goog.object.set(G__39014,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__39015 = props;
var G__39015__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39015,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39015);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39015__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39018 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39018,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39018;
}
})(),id_class);
...
var G__39024 = (cljs.core.count(argv) - first_child);
switch (G__39024) {
case (0):
...
var vec__39028 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39028,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39028,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39028,(2),null);
...
var temp__5739__auto___39075 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39075 == null)){
} else {
var key_39076 = temp__5739__auto___39075;
(jsprops.key = key_39076);
}
...
var temp__5739__auto___39079 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39079 == null)){
} else {
var key_39080 = temp__5739__auto___39079;
(jsprops.key = key_39080);
}
...
var temp__5739__auto___39085 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___39085 == null)){
} else {
var key_39086 = temp__5739__auto___39085;
(jsprops.key = key_39086);
}
...
var temp__5739__auto___39105 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39105 == null)){
} else {
var key_39107 = temp__5739__auto___39105;
(jsprops.key = key_39107);
}
...
var temp__5739__auto___39108 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39108 == null)){
} else {
var key_39109 = temp__5739__auto___39108;
(jsprops.key = key_39109);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39039_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39039_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39041 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39041,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39041,(1),null);
...
break;
default:
var G__39117 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__39118 = compiler;
v = G__39117;
compiler = G__39118;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template39054 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template39054 = (function (opts,id,fn_to_element,meta39055){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta39055 = meta39055;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template39054.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39056,meta39055__$1){
var self__ = this;
var _39056__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39054(self__.opts,self__.id,self__.fn_to_element,meta39055__$1));
}));

(reagent.impl.template.t_reagent$impl$template39054.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39056){
var self__ = this;
var _39056__$1 = this;
return self__.meta39055;
}));

(reagent.impl.template.t_reagent$impl$template39054.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39054.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39054.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39054.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39054.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta39055","meta39055",-108342301,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39054.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39054.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39054");

(reagent.impl.template.t_reagent$impl$template39054.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template39054");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39054.
 */
reagent.impl.template.__GT_t_reagent$impl$template39054 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template39054(opts__$1,id__$1,fn_to_element__$1,meta39055){
return (new reagent.impl.template.t_reagent$impl$template39054(opts__$1,id__$1,fn_to_element__$1,meta39055));
});

}

return (new reagent.impl.template.t_reagent$impl$template39054(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
