...
var G__36048 = clojure.zip.node(loc);
var fexpr__36047 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var G__36051 = clojure.zip.node(loc);
var fexpr__36050 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__36050.cljs$core$IFn$_invoke$arity$1 ? fexpr__36050.cljs$core$IFn$_invoke$arity$1(G__36051) : fexpr__36050.call(null,G__36051));
} else {
...
var fexpr__36053 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__36053.cljs$core$IFn$_invoke$arity$2 ? fexpr__36053.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__36053.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__36058 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36058,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36058,(1),null);
var vec__36061 = clojure.zip.children(loc);
var seq__36062 = cljs.core.seq(vec__36061);
var first__36063 = cljs.core.first(seq__36062);
var seq__36062__$1 = cljs.core.next(seq__36062);
var c = first__36063;
var cnext = seq__36062__$1;
var cs = vec__36061;
...
var vec__36067 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36067,(0),null);
var map__36070 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36067,(1),null);
...
var path = map__36070__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36070__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36070__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36070__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36070__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36070__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__36075 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36075,(0),null);
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36078__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__36079 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36078__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__36088 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36088,(0),null);
var map__36091 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36088,(1),null);
...
var path = map__36091__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36091__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36091__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return r;
} else {
...
var vec__36096 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36096,(0),null);
...
var path = map__36099__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36099__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36099__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
...
var vec__36104 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36104,(0),null);
var map__36107 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36104,(1),null);
...
var path = map__36107__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36107__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36107__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__36113 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36113,(0),null);
...
var path = map__36116__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36116__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__36122 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36122,(0),null);
var map__36125 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36122,(1),null);
...
var path = map__36125__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36125__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__36130 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36130,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36130,(1),null);
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq36133){
...
var G__36218 = clojure.zip.rightmost(child);
loc__$1 = G__36218;
continue;
} else {
return loc__$1;
...
var vec__36182 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36182,(0),null);
...
var path = map__36185__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36185__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36185__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36185__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36185__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__36227 = clojure.zip.rightmost(child);
loc__$1 = G__36227;
continue;
} else {
return loc__$1;
