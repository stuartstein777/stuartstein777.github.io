...
var i_27735 = (self__.level + (1));
while(true){
if((i_27735 <= (new_level + (1)))){
(update[i_27735] = self__.header);

var G__27736 = (i_27735 + (1));
i_27735 = G__27736;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_27737 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_27737[i]));
} else {
x__$2.forward.push((((i < links_27737.length))?(links_27737[i]):null));
}

if((i < links_27737.length)){
(links_27737[i] = x__$2);
} else {
links_27737.push(x__$2);
}
...
var i_27745 = (0);
while(true){
if((i_27745 <= self__.level)){
var links_27746 = (update[i_27745]).forward;
if((x__$1 === (((i_27745 < links_27746.length))?(links_27746[i_27745]):null))){
(links_27746[i_27745] = (x__$1.forward[i_27745]));

var G__27747 = (i_27745 + (1));
i_27745 = G__27747;
continue;
} else {
var G__27748 = (i_27745 + (1));
i_27745 = G__27748;
continue;
}
} else {
...
var G__27750 = nx;
var G__27751 = (level__$1 - (1));
x = G__27750;
level__$1 = G__27751;
continue;
} else {
var G__27752 = x;
var G__27753 = (level__$1 - (1));
x = G__27752;
level__$1 = G__27753;
continue;
}
