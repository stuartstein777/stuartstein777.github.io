...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__30923){
var map__30924 = p__30923;
var map__30924__$1 = cljs.core.__destructure_map(map__30924);
var request = map__30924__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30924__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__30937 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__30937.cljs$core$IFn$_invoke$arity$1 ? fexpr__30937.cljs$core$IFn$_invoke$arity$1(response) : fexpr__30937.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__30938 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__30938.cljs$core$IFn$_invoke$arity$1 ? fexpr__30938.cljs$core$IFn$_invoke$arity$1(response) : fexpr__30938.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__30942){
var map__30943 = p__30942;
var map__30943__$1 = cljs.core.__destructure_map(map__30943);
var request = map__30943__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30943__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
