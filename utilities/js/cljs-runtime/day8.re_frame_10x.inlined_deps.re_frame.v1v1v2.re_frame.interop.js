...
return [(function (){var pred__19270 = cljs.core.instance_QMARK_;
var expr__19271 = reactive_val;
if(cljs.core.truth_((pred__19270.cljs$core$IFn$_invoke$arity$2 ? pred__19270.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__19271) : pred__19270.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__19271)))){
return "ra";
} else {
if(cljs.core.truth_((pred__19270.cljs$core$IFn$_invoke$arity$2 ? pred__19270.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__19271) : pred__19270.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__19271)))){
return "rc";
} else {
if(cljs.core.truth_((pred__19270.cljs$core$IFn$_invoke$arity$2 ? pred__19270.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__19271) : pred__19270.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__19271)))){
return "rx";
} else {
if(cljs.core.truth_((pred__19270.cljs$core$IFn$_invoke$arity$2 ? pred__19270.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__19271) : pred__19270.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__19271)))){
return "tr";
} else {
return "other";
}
