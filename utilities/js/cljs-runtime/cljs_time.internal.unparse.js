...
var periods__$1 = cljs.core.vec((function (){var G__32215 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32214_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__32214_SHARP_,(0),(3));
}),G__32215);
} else {
return G__32215;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__32230){
var vec__32231 = p__32230;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32231,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32231,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__32234 = pattern;
switch (G__32234) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32234)].join('')));
...
return p1__32235_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__32236_SHARP_){
return p1__32236_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__32237_SHARP_){
return p1__32237_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__32238_SHARP_){
return p1__32238_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__32239_SHARP_){
return p1__32239_SHARP_.getHours();
});

break;
case "day":
return (function (p1__32240_SHARP_){
return p1__32240_SHARP_.getDate();
});

break;
case "month":
return (function (p1__32241_SHARP_){
return p1__32241_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__32242_SHARP_){
return p1__32242_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__32244){
var vec__32245 = p__32244;
var seq__32246 = cljs.core.seq(vec__32245);
var first__32247 = cljs.core.first(seq__32246);
var seq__32246__$1 = cljs.core.next(seq__32246);
var key = first__32247;
var args = seq__32246__$1;
var G__32248 = key;
...
break;
case "ordinal-suffix":
var vec__32249 = (function (){var G__32252 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__32252) : syntax_list.call(null,G__32252));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32249,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32248__$1)].join('')));
...
var d = value;
var G__32256 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__32257 = G__32256;
...
var unparser = first__32259;
var more = seq__32258__$1;
var s = "";
var d__$1 = d;
var G__32256__$1 = G__32256;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__32266 = G__32256__$1;
...
var unparser__$1 = first__32268;
var more__$1 = seq__32267__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__32269 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32269,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32269,(1),null);
var G__32307 = d__$3;
var G__32308 = more__$1;
var G__32309 = s__$3;
d__$1 = G__32307;
G__32256__$1 = G__32308;
s__$1 = G__32309;
continue;
}
break;
