...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__20474_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20474_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__20474_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__20476){
var vec__20481 = p__20476;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20481,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20481,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__20488,s,color,element,idx){
var map__20489 = p__20488;
var map__20489__$1 = cljs.core.__destructure_map(map__20489);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20489__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20489__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20489__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__20494 = (function (){var or__5045__auto__ = color;
...
var fexpr__20493 = (function (){var G__20495 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__20495) : style_map.call(null,G__20495));
})();
return (fexpr__20493.cljs$core$IFn$_invoke$arity$1 ? fexpr__20493.cljs$core$IFn$_invoke$arity$1(G__20494) : fexpr__20493.call(null,G__20494));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__20502){
var vec__20503 = p__20502;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20503,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20503,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20503,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__20507){
var vec__20508 = p__20507;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20508,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20508,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20508,(2),null);
...
var G__20658 = cljs.core.next(ssv);
var G__20659 = (this_ssv == null);
var G__20660 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__20661 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__20658;
doing_nil_QMARK_ = G__20659;
last_elide = G__20660;
out = G__20661;
continue;
}
...
var vec__20521 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20521,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20521,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20521,(2),null);
...
var G__20667 = cljs.core.next(remaining_cvec);
var G__20668 = new_idx;
var G__20669 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__20667;
idx = G__20668;
out = G__20669;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__20549,cursor_vec){
var vec__20550 = p__20549;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20550,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20550,(1),null);
var focus_vec = vec__20550;
...
var vec__20553 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20553,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20553,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__20556){
var vec__20558 = p__20556;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20558,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20558,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__20568,existing_count){
var vec__20569 = p__20568;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20569,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20569,(1),null);
...
return cljs.core.filterv((function (p1__20563_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__20563_SHARP_))));
...
var vec__20586 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20586,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20586,(1),null);
var cvec_element = vec__20586;
if((cvec_element == null)){
var G__20713 = cljs.core.next(cvec_nl);
var G__20714 = (idx + (1));
var G__20715 = start;
var G__20716 = out;
cvec_nl = G__20713;
...
var G__20717 = cljs.core.next(cvec_nl);
var G__20718 = (idx + (1));
var G__20719 = idx;
var G__20720 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__20717;
idx = G__20718;
start = G__20719;
out = G__20720;
...
var G__20721 = cljs.core.next(cvec_nl);
var G__20722 = (idx + (1));
var G__20723 = (idx + (1));
var G__20724 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__20721;
idx = G__20722;
start = G__20723;
out = G__20724;
...
var G__20725 = cljs.core.next(cvec_nl);
var G__20726 = (idx + (1));
var G__20727 = idx;
...
var G__20729 = cljs.core.next(cvec_nl);
var G__20730 = (idx + (1));
var G__20731 = start;
var G__20732 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__20729;
idx = G__20730;
start = G__20731;
out = G__20732;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__20595_SHARP_,p2__20594_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__20594_SHARP_)){
return cljs.core.reduced(p1__20595_SHARP_);
} else {
return (p1__20595_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__20601,p__20602){
var vec__20603 = p__20601;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20603,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20603,(1),null);
var vec__20606 = p__20602;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20606,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20606,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__20621,cvec,focus_vec){
var map__20622 = p__20621;
var map__20622__$1 = cljs.core.__destructure_map(map__20622);
var options = map__20622__$1;
var map__20623 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20622__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__20623__$1 = cljs.core.__destructure_map(map__20623);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20623__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20623__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20623__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20619_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__20619_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
