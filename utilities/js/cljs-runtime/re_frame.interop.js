...
return [(function (){var pred__24339 = cljs.core.instance_QMARK_;
var expr__24340 = reactive_val;
if(cljs.core.truth_((pred__24339.cljs$core$IFn$_invoke$arity$2 ? pred__24339.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__24340) : pred__24339.call(null,reagent.ratom.RAtom,expr__24340)))){
return "ra";
} else {
if(cljs.core.truth_((pred__24339.cljs$core$IFn$_invoke$arity$2 ? pred__24339.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__24340) : pred__24339.call(null,reagent.ratom.RCursor,expr__24340)))){
return "rc";
} else {
if(cljs.core.truth_((pred__24339.cljs$core$IFn$_invoke$arity$2 ? pred__24339.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__24340) : pred__24339.call(null,reagent.ratom.Reaction,expr__24340)))){
return "rx";
} else {
if(cljs.core.truth_((pred__24339.cljs$core$IFn$_invoke$arity$2 ? pred__24339.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__24340) : pred__24339.call(null,reagent.ratom.Track,expr__24340)))){
return "tr";
} else {
return "other";
}
