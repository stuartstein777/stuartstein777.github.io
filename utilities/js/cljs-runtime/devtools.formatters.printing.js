...
var len__5769__auto___14168 = arguments.length;
var i__5770__auto___14169 = (0);
while(true){
if((i__5770__auto___14169 < len__5769__auto___14168)){
args__5775__auto__.push((arguments[i__5770__auto___14169]));

var G__14170 = (i__5770__auto___14169 + (1));
i__5770__auto___14169 = G__14170;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14114){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14115,G__14116,seq14114__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14143_SHARP_){
return (!((cljs.core.meta(p1__14143_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14152__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e14153){var _e__12900__auto__ = e14153;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e14155){var _e__12900__auto__ = e14155;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__14158 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__14159 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__14159);

try{var map__14160 = opts;
var map__14160__$1 = cljs.core.__destructure_map(map__14160);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14160__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__14158);
}});
...
var temp__5802__auto___14178 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___14178)){
var managed_print_level_14179 = temp__5802__auto___14178;
var _STAR_print_level_STAR__orig_val__14165_14180 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14166_14181 = managed_print_level_14179;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14166_14181);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__14161_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__14161_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14165_14180);
}} else {
job_fn();
}
