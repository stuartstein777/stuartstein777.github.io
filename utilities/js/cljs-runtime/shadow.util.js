...
var len__5769__auto___27721 = arguments.length;
var i__5770__auto___27722 = (0);
while(true){
if((i__5770__auto___27722 < len__5769__auto___27721)){
args_arr__5794__auto__.push((arguments[i__5770__auto___27722]));

var G__27723 = (i__5770__auto___27722 + (1));
i__5770__auto___27722 = G__27723;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq27695){
...
var G__27698 = cljs.core.first(seq27695__$2);
var seq27695__$3 = cljs.core.next(seq27695__$2);
var G__27699 = cljs.core.first(seq27695__$3);
var seq27695__$4 = cljs.core.next(seq27695__$3);
var G__27700 = cljs.core.first(seq27695__$4);
var seq27695__$5 = cljs.core.next(seq27695__$4);
var G__27701 = cljs.core.first(seq27695__$5);
var seq27695__$6 = cljs.core.next(seq27695__$5);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27696,G__27697,G__27698,G__27699,G__27700,G__27701,seq27695__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__27712){
var vec__27713 = p__27712;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27713,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27713,(1),null);
