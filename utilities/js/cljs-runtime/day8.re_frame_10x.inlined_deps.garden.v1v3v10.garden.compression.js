 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__17095){
var vec__17096 = p__17095;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17096,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17096,(1),null);
return (function (s){
...
var len__5769__auto___17120 = arguments.length;
var i__5770__auto___17121 = (0);
while(true){
if((i__5770__auto___17121 < len__5769__auto___17120)){
args__5775__auto__.push((arguments[i__5770__auto___17121]));

var G__17122 = (i__5770__auto___17121 + (1));
i__5770__auto___17121 = G__17122;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__17100_SHARP_){
return (p1__17100_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__17100_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__17100_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq17104){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq17104));
}));
...
var map__17115 = temp__5802__auto__;
var map__17115__$1 = cljs.core.__destructure_map(map__17115);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17115__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17115__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17115__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__17124 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__17125 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__17118 = tag;
