...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_16797 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_16797(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_16799 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_16799(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16800 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16800(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16801 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16801(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16802 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16802(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16803 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16803(reader);
}
});
...
var G__16811 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__16812 = s.append(c);
c = G__16811;
s = G__16812;
continue;
}
