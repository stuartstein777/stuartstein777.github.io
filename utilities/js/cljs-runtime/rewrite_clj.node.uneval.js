...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k21117,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21117,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__21126){
var vec__21127 = p__21126;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21127,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21127,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21116){
var self__ = this;
var G__21116__$1 = this;
return (new cljs.core.RecordIter((0),G__21116__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21118,other21119){
var self__ = this;
var this21118__$1 = this;
return (((!((other21119 == null)))) && ((((this21118__$1.constructor === other21119.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21118__$1.children,other21119.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21118__$1.__extmap,other21119.__extmap)))))));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k21117){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k21117);

}
}));

(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__21116){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__21178 = cljs.core.keyword_identical_QMARK_;
var expr__21179 = k__5352__auto__;
if(cljs.core.truth_((pred__21178.cljs$core$IFn$_invoke$arity$2 ? pred__21178.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__21179) : pred__21178.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__21179)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__21116,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__21116),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__21116){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__21116,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__21120){
var extmap__5385__auto__ = (function (){var G__21195 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__21120,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__21120)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__21195);
} else {
return G__21195;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__21120),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__21228 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__21228;
continue;
}
break;
