...
var G__22102 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__22102__$1 = (((G__22102 == null))?null:cljs.core.iterate((function (loc){
...
var G__22102__$2 = (((G__22102__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__22102__$1));
var G__22102__$3 = (((G__22102__$2 == null))?null:cljs.core.last(G__22102__$2));
if((G__22102__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__22102__$3);
}
} else {
return zloc;
}
...
var G__22111 = rewrite_clj.zip.move.right(v);
var G__22112 = rewrite_clj.zip.move.up(v);
loc = G__22111;
parent = G__22112;
continue;
} else {
var G__22113 = rewrite_clj.zip.move.right(v0);
var G__22114 = parent;
loc = G__22113;
parent = G__22114;
continue;
...
var G__22115 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__22116 = rewrite_clj.zip.move.up(v);
loc = G__22115;
parent = G__22116;
continue;
} else {
var G__22117 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__22118 = parent;
loc = G__22117;
parent = G__22118;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__22106 = zloc;
var G__22106__$1 = (((G__22106 == null))?null:rewrite_clj.zip.move.down(G__22106));
var G__22106__$2 = (((G__22106__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__22106__$1,k));
if((G__22106__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__22106__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__22110 = rewrite_clj.zip.move.down(zloc);
var G__22110__$1 = (((G__22110 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__22110));
if((G__22110__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__22110__$1);
}
})(),k);
}
});
