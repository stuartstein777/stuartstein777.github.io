...
var G__25371 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,i_s);
var G__25372 = (i_s + (1));
var G__25373 = (i_s_SINGLEQUOTE_ + (1));
v = G__25371;
i_s = G__25372;
i_s_SINGLEQUOTE_ = G__25373;
continue;
} else {
var G__25374 = v;
var G__25375 = (i_s + (1));
var G__25376 = i_s_SINGLEQUOTE_;
v = G__25374;
i_s = G__25375;
i_s_SINGLEQUOTE_ = G__25376;
continue;
...
var vec__25302 = day8.re_frame_10x.view.event.collapse_whitespace_and_index(form_str);
var form_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25302,(0),null);
var reindex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25302,(1),null);
...
var vec__25309 = result;
var vec__25312 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25309,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25312,(0),null);
var pre_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25312,(1),null);
var matched_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25312,(2),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25309,(1),null);
...
var start = (function (){var G__25315 = form_str__$1;
var G__25315__$1 = (((G__25315 == null))?null:clojure.string.index_of.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([search_str], 0)),G__25315));
if((G__25315__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__25315__$1);
}
})();
...
var end = (function (){var G__25331 = start;
var G__25331__$1 = (((G__25331 == null))?null:(length + G__25331));
if((G__25331__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__25331__$1);
}
})();
...
var vec__25332 = day8.re_frame_10x.view.event.find_bounds(form_str,new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(highlighted_form),new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431).cljs$core$IFn$_invoke$arity$1(highlighted_form));
var start_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25332,(0),null);
var end_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25332,(1),null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.h_box,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function day8$re_frame_10x$view$event$indent_block_$_iter__25335(s__25336){
return (new cljs.core.LazySeq(null,(function (){
var s__25336__$1 = s__25336;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__25336__$1);
if(temp__5804__auto__){
var s__25336__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25336__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__25336__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__25338 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__25337 = (0);
while(true){
if((i__25337 < size__5522__auto__)){
var num = cljs.core._nth(c__5521__auto__,i__25337);
cljs.core.chunk_append(b__25338,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.box,new cljs.core.Keyword(null,"width","width",-384071477),"12px",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"background-color","background-color",570434026),day8.re_frame_10x.common_styles.standard_background_color,new cljs.core.Keyword(null,"border-top","border-top",-158897573),(cljs.core.truth_(first_QMARK_)?day8.re_frame_10x.view.event.code_border:null),new cljs.core.Keyword(null,"border-left","border-left",-1150760178),day8.re_frame_10x.view.event.code_border], null),new cljs.core.Keyword(null,"child","child",623967545),""], null));
...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"size","size",1098693007),"1",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"overflow-y","overflow-y",-1436589285),"auto"], null),new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function day8$re_frame_10x$view$event$event_fragments_$_iter__25340(s__25341){
return (new cljs.core.LazySeq(null,(function (){
var s__25341__$1 = s__25341;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__25341__$1);
if(temp__5804__auto__){
var s__25341__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25341__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__25341__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__25343 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__25342 = (0);
while(true){
if((i__25342 < size__5522__auto__)){
var frag = cljs.core._nth(c__5521__auto__,i__25342);
cljs.core.chunk_append(b__25343,(function (){var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(frag);
var first_QMARK_ = (id === (0));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"code-fragment",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),((first_QMARK_)?null:"-1px")], null),new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-enter","on-mouse-enter",-1664921661),((function (i__25342,id,first_QMARK_,frag,c__5521__auto__,size__5522__auto__,b__25343,s__25341__$2,temp__5804__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
...
return null;
});})(i__25342,id,first_QMARK_,frag,c__5521__auto__,size__5522__auto__,b__25343,s__25341__$2,temp__5804__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (i__25342,id,first_QMARK_,frag,c__5521__auto__,size__5522__auto__,b__25343,s__25341__$2,temp__5804__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25343),day8$re_frame_10x$view$event$event_fragments_$_iter__25340(cljs.core.chunk_rest(s__25341__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25343),null);
}
} else {
var frag = cljs.core.first(s__25341__$2);
return cljs.core.cons((function (){var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(frag);
var first_QMARK_ = (id === (0));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"code-fragment",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),((first_QMARK_)?null:"-1px")], null),new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-enter","on-mouse-enter",-1664921661),((function (id,first_QMARK_,frag,s__25341__$2,temp__5804__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","hover-form","code/hover-form",1557522458),frag], null));

return null;
});})(id,first_QMARK_,frag,s__25341__$2,temp__5804__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (id,first_QMARK_,frag,s__25341__$2,temp__5804__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","exit-hover-form","code/exit-hover-form",-202062797),frag], null));
...
})(),day8$re_frame_10x$view$event$event_fragments_$_iter__25340(cljs.core.rest(s__25341__$2)));
}
} else {
return null;
}
...
return iter__5523__auto__(cljs.core.take.cljs$core$IFn$_invoke$arity$2(max_frags,fragments));
