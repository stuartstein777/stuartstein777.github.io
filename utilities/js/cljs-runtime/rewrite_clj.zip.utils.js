...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__21892,k,f){
var vec__21893 = p__21892;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21893,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21893,(1),null);
var loc = vec__21893;
...
var G__21943 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__21943;
continue;
}
break;
...
var G__21944 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__21944;
continue;
} else {
return zloc__$1;
...
var G__21951 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__21951;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__21916){
var vec__21917 = p__21916;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21917,(0),null);
var map__21920 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21917,(1),null);
var map__21920__$1 = cljs.core.__destructure_map(map__21920);
var path = map__21920__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21920__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__21917;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__21925){
var vec__21926 = p__21925;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21926,(0),null);
var map__21929 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21926,(1),null);
var map__21929__$1 = cljs.core.__destructure_map(map__21929);
var path = map__21929__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21929__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__21926;
if(cljs.core.seq(r)){
...
var vec__21931 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21931,(0),null);
var map__21934 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21931,(1),null);
var map__21934__$1 = cljs.core.__destructure_map(map__21934);
var path = map__21934__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21934__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21934__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21934__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21934__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
