...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23716 = c;
var G__23716__$1 = (((G__23716 == null))?null:G__23716.prototype);
if((G__23716__$1 == null)){
return null;
} else {
return G__23716__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23722 = c;
var G__23722__$1 = (((G__23722 == null))?null:G__23722.prototype);
if((G__23722__$1 == null)){
return null;
} else {
return G__23722__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__23902__delegate = function (args){
...
while (G__23903__i < G__23903__a.length) {G__23903__a[G__23903__i] = arguments[G__23903__i + 0]; ++G__23903__i;}
  args = new cljs.core.IndexedSeq(G__23903__a,0,null);
} 
...
var args = cljs.core.seq(arglist__23904);
...
var or__5045__auto__ = (function (){var G__23796 = c;
var G__23796__$1 = (((G__23796 == null))?null:G__23796.constructor);
if((G__23796__$1 == null)){
return null;
} else {
return G__23796__$1.displayName;
}
})();
...
var G__23800 = c;
var G__23800__$1 = (((G__23800 == null))?null:G__23800.constructor);
if((G__23800__$1 == null)){
return null;
} else {
return G__23800__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__23806 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23807 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23807);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23806);
}});
...
var c = this;
var G__23833_23919 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__23833_23919 == null)){
} else {
reagent.ratom.dispose_BANG_(G__23833_23919);
}
...
var renders_23932 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_23933 = cljs.core.first(cljs.core.vals(renders_23932));
...
if((cljs.core.count(renders_23932) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23932))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23933)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23933], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__23854 = o;
reagent.impl.component.goog$module$goog$object.set(G__23854,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__23885 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23886 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23886);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23885);
}});
...
var vec__23890 = shadow.js.shim.module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23890,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23890,(1),null);
...
var G__23893 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__23893 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__23893);
}
});
}),[]);
