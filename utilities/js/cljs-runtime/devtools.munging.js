...
var o13711 = temp__5802__auto__;
var temp__5802__auto____$1 = (o13711["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o13712 = temp__5802__auto____$1;
return (o13712["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12878__auto__ = f;
return (o__12878__auto__["toString"]).call(o__12878__auto__);
} else {
return "";
}
...
try{var o__12878__auto___14008 = t;
(o__12878__auto___14008["cljs$lang$ctorPrWriter"]).call(o__12878__auto___14008,t,writer);
}catch (e13723){var __14010 = e13723;
}
...
var char_code = (function (){var o__12878__auto__ = (new String(char$));
return (o__12878__auto__["charCodeAt"]).call(o__12878__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12878__auto__ = String;
return (o__12878__auto__["fromCharCode"]).call(o__12878__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13732 = num_code;
switch (G__13732) {
case (1):
return (185);
...
var o__12878__auto__ = String;
return (o__12878__auto__["fromCharCode"]).call(o__12878__auto__,superscript_code);
});
/**
...
}catch (e13746){var _e__12900__auto__ = e13746;
return false;
}})())){
...
var vec__13747 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13747,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var o13753 = temp__5802__auto__;
var temp__5802__auto____$1 = (o13753["dependencies_"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o13754 = temp__5802__auto____$1;
return (o13754["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13757){
var vec__13758 = p__13757;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13758,(0),null);
...
var G__14047 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__14048 = cljs.core.butlast(remaining_tokens);
name_tokens = G__14047;
remaining_tokens = G__14048;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13755){
var G__13756 = cljs.core.first(seq13755);
var seq13755__$1 = cljs.core.next(seq13755);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13756,seq13755__$1);
}));
...
var vec__13770 = cljs.core.split_with((function (p1__13769_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__13769_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13770,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13770,(1),null);
...
var vec__13777 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13777,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13777,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__14057 = cljs.core.rest(remaining_tokens);
var G__14058 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__14057;
name_tokens = G__14058;
continue;
} else {
...
var vec__13789 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13789,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13789,(1),null);
var vec__13792 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13792,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13792,(1),null);
var vec__13795 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13795,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13795,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13795,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13795,(3),null);
...
var vec__13803 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13803,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13803,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13803,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13803,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13803,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13803,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__13836 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13836,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13836,(1),null);
var vec__13839 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13839,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13839,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__13844 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__13844) : devtools.munging.parse_fn_info_deep.call(null,G__13844));
})()));
}
} else {
return fn_info;
...
var G__14089 = (arity + (1));
var G__14090 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13859){
var vec__13860 = p__13859;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13860,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13860,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13866_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__13866_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13867_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__13867_SHARP_);
}),sorted_infos);
...
var i__5770__auto___14108 = (0);
while(true){
if((i__5770__auto___14108 < len__5769__auto___14103)){
args__5775__auto__.push((arguments[i__5770__auto___14108]));

var G__14109 = (i__5770__auto___14108 + (1));
i__5770__auto___14108 = G__14109;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13879){
var vec__13881 = p__13879;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13881,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13874){
...
var map__13918 = options;
var map__13918__$1 = cljs.core.__destructure_map(map__13918);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13918__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13918__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13918__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13918__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13919 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13919,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13919,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13919,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13919,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13919,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13919,(5),null);
...
var o__12878__auto__ = f;
return (o__12878__auto__["getBasis"]).call(o__12878__auto__);
});
/**
...
}catch (e13933){var _e__12900__auto__ = e13933;
...
var G__14139 = (obj[cljs.core.first(path)]);
var G__14140 = cljs.core.rest(path);
obj = G__14139;
path = G__14140;
continue;
} else {
...
var _STAR_ = (function (accum,p__13956){
var vec__13957 = p__13956;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13957,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13957,(1),null);
...
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13972,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13972,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13972,(2),null);
...
var post_process = (function (p__13989){
var vec__13990 = p__13989;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13990,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13990,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13984_SHARP_){
return (obj[cljs.core.first(p1__13984_SHARP_)]);
}),sorted_matches);
