...
var vec__24891 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__24894 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24894,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24894,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24891,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24891,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__24897){
var vec__24898 = p__24897;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24898,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24898,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24901,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24901,(1),null);
...
var vec__24905 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24905,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24905,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24905,(2),null);
var vec__24908 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24908,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24908,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24908,(2),null);
...
var G__24911 = special_option;
var G__24911__$1 = (((G__24911 instanceof cljs.core.Keyword))?G__24911.fqn:null);
switch (G__24911__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__24912){
var vec__24913 = p__24912;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24913,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24913,(1),null);
...
var vec__24917 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24917,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24917,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24917,(2),null);
...
var vec__24927 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24927,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24927,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24927,(2),null);
var tuple = vec__24927;
...
var G__25140 = cljs.core.next(style_vec);
var G__25141 = ends_w_blanks_QMARK_;
var G__25142 = tuple;
var G__25143 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__25140;
previous_ends_w_blanks_QMARK_ = G__25141;
previous_tuple = G__25142;
out = G__25143;
continue;
}
break;
...
var len__5769__auto___25147 = arguments.length;
var i__5770__auto___25148 = (0);
while(true){
if((i__5770__auto___25148 < len__5769__auto___25147)){
args__5775__auto__.push((arguments[i__5770__auto___25148]));

var G__25149 = (i__5770__auto___25148 + (1));
i__5770__auto___25148 = G__25149;
continue;
} else {
}
break;
...
var vec__24938 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24938,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24938,(1),null);
...
var result = (function (){var G__24941 = zprint.core.parse_string_all_options(rest_options);
var G__24942 = zprint.core.zprint_str_internal;
var G__24943 = ":parse-string-all? call";
var G__24944 = (function (){var G__24945 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__24945) : zprint.zutil.edn_STAR_.call(null,G__24945));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__24941,G__24942,G__24943,G__24944) : zprint.core.process_multiple_forms.call(null,G__24941,G__24942,G__24943,G__24944));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__24946 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24946,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24946,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq24935){
var G__24936 = cljs.core.first(seq24935);
var seq24935__$1 = cljs.core.next(seq24935);
var G__24937 = cljs.core.first(seq24935__$1);
var seq24935__$2 = cljs.core.next(seq24935__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24936,G__24937,seq24935__$2);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___25153 = arguments.length;
var i__5770__auto___25154 = (0);
while(true){
if((i__5770__auto___25154 < len__5769__auto___25153)){
args__5775__auto__.push((arguments[i__5770__auto___25154]));

var G__25155 = (i__5770__auto___25154 + (1));
i__5770__auto___25154 = G__25155;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq24953){
var G__24954 = cljs.core.first(seq24953);
var seq24953__$1 = cljs.core.next(seq24953);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24954,seq24953__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___25160 = arguments.length;
var i__5770__auto___25161 = (0);
while(true){
if((i__5770__auto___25161 < len__5769__auto___25160)){
args__5775__auto__.push((arguments[i__5770__auto___25161]));

var G__25162 = (i__5770__auto___25161 + (1));
i__5770__auto___25161 = G__25162;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq24958){
var G__24959 = cljs.core.first(seq24958);
var seq24958__$1 = cljs.core.next(seq24958);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24959,seq24958__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___25163 = arguments.length;
var i__5770__auto___25164 = (0);
while(true){
if((i__5770__auto___25164 < len__5769__auto___25163)){
args__5775__auto__.push((arguments[i__5770__auto___25164]));

var G__25165 = (i__5770__auto___25164 + (1));
i__5770__auto___25164 = G__25165;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq24971){
var G__24972 = cljs.core.first(seq24971);
var seq24971__$1 = cljs.core.next(seq24971);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24972,seq24971__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___25166 = arguments.length;
var i__5770__auto___25167 = (0);
while(true){
if((i__5770__auto___25167 < len__5769__auto___25166)){
args__5775__auto__.push((arguments[i__5770__auto___25167]));

var G__25168 = (i__5770__auto___25167 + (1));
i__5770__auto___25167 = G__25168;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq24981){
var G__24982 = cljs.core.first(seq24981);
var seq24981__$1 = cljs.core.next(seq24981);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24982,seq24981__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__24998,form){
var vec__24999 = p__24998;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24999,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24999,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24999,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24999,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__25003 = (cljs.core.truth_((function (){var and__5043__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__5043__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25003,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25003,(1),null);
...
var G__25173 = cljs.core.next(sos);
var G__25174 = comment_QMARK_;
var G__25175 = (function (){var or__5045__auto__ = (!(empty_string_QMARK_));
if(or__5045__auto__){
return or__5045__auto__;
} else {
...
var G__25176 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__25173;
previous_comment_QMARK_ = G__25174;
start_interpolating_QMARK_ = G__25175;
out = G__25176;
continue;
}
break;
...
try{var vec__25061 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25061,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25061,(1),null);
...
var vec__25064 = (cljs.core.truth_((function (){var or__5045__auto__ = range_start__$1;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25064,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25064,(1),null);
...
var vec__25067 = (cljs.core.truth_((function (){var and__5043__auto__ = actual_start;
if(cljs.core.truth_(and__5043__auto__)){
return actual_end;
} else {
return and__5043__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25067,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25067,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25067,(2),null);
...
var forms = (function (){var G__25088 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__25088) : zprint.zutil.edn_STAR_.call(null,G__25088));
})();
