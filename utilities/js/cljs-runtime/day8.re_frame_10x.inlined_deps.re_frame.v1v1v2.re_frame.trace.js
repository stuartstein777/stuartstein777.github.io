...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__19924){
var map__19925 = p__19924;
var map__19925__$1 = cljs.core.__destructure_map(map__19925);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19925__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19925__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19925__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19925__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__19927_19955 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__19928_19956 = null;
var count__19929_19957 = (0);
var i__19930_19958 = (0);
while(true){
if((i__19930_19958 < count__19929_19957)){
var vec__19942_19959 = chunk__19928_19956.cljs$core$IIndexed$_nth$arity$2(null,i__19930_19958);
var k_19960 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19942_19959,(0),null);
var cb_19961 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19942_19959,(1),null);
try{var G__19946_19962 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_19961.cljs$core$IFn$_invoke$arity$1 ? cb_19961.cljs$core$IFn$_invoke$arity$1(G__19946_19962) : cb_19961.call(null,G__19946_19962));
}catch (e19945){var e_19963 = e19945;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_19960,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_19963], 0));
}

var G__19964 = seq__19927_19955;
var G__19965 = chunk__19928_19956;
var G__19966 = count__19929_19957;
var G__19967 = (i__19930_19958 + (1));
seq__19927_19955 = G__19964;
chunk__19928_19956 = G__19965;
count__19929_19957 = G__19966;
i__19930_19958 = G__19967;
continue;
} else {
var temp__5804__auto___19968 = cljs.core.seq(seq__19927_19955);
if(temp__5804__auto___19968){
var seq__19927_19969__$1 = temp__5804__auto___19968;
if(cljs.core.chunked_seq_QMARK_(seq__19927_19969__$1)){
var c__5568__auto___19970 = cljs.core.chunk_first(seq__19927_19969__$1);
var G__19971 = cljs.core.chunk_rest(seq__19927_19969__$1);
var G__19972 = c__5568__auto___19970;
var G__19973 = cljs.core.count(c__5568__auto___19970);
var G__19974 = (0);
seq__19927_19955 = G__19971;
chunk__19928_19956 = G__19972;
count__19929_19957 = G__19973;
i__19930_19958 = G__19974;
continue;
} else {
var vec__19947_19975 = cljs.core.first(seq__19927_19969__$1);
var k_19976 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19947_19975,(0),null);
var cb_19977 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19947_19975,(1),null);
try{var G__19951_19978 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_19977.cljs$core$IFn$_invoke$arity$1 ? cb_19977.cljs$core$IFn$_invoke$arity$1(G__19951_19978) : cb_19977.call(null,G__19951_19978));
}catch (e19950){var e_19979 = e19950;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_19976,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_19979], 0));
}

var G__19980 = cljs.core.next(seq__19927_19969__$1);
var G__19981 = null;
var G__19982 = (0);
var G__19983 = (0);
seq__19927_19955 = G__19980;
chunk__19928_19956 = G__19981;
count__19929_19957 = G__19982;
i__19930_19958 = G__19983;
continue;
}
} else {
}
