...
var o27925 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27925["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27926 = temp__5733__auto____$1;
return (o27926["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27736__auto__ = f;
return (o__27736__auto__["toString"]).call(o__27736__auto__);
} else {
return "";
}
}catch (e27928){var _ = e27928;
return "";
}});
...
try{var o__27736__auto___28158 = t;
(o__27736__auto___28158["cljs$lang$ctorPrWriter"]).call(o__27736__auto___28158,t,writer);
}catch (e27935){var __28159 = e27935;
}
...
var char_code = (function (){var o__27736__auto__ = (new String(char$));
return (o__27736__auto__["charCodeAt"]).call(o__27736__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27736__auto__ = String;
return (o__27736__auto__["fromCharCode"]).call(o__27736__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27942 = num_code;
switch (G__27942) {
case (1):
return (185);
...
var o__27736__auto__ = String;
return (o__27736__auto__["fromCharCode"]).call(o__27736__auto__,superscript_code);
});
/**
...
}catch (e27950){var _e__27752__auto__ = e27950;
return false;
}})())){
...
var vec__27959 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27959,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o27978 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27978["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27979 = temp__5733__auto____$1;
return (o27979["nameToPath"]);
} else {
return null;
}
} else {
...
var G__28180 = (i__4737__auto___28176 + (1));
i__4737__auto___28176 = G__28180;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27984){
var vec__27985 = p__27984;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27985,(0),null);
...
var G__28182 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28183 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28182;
remaining_tokens = G__28183;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27981){
var G__27982 = cljs.core.first(seq27981);
var seq27981__$1 = cljs.core.next(seq27981);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27982,seq27981__$1);
}));
...
var vec__27998 = cljs.core.split_with((function (p1__27990_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27990_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27998,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27998,(1),null);
...
var vec__28004 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28004,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28004,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28186 = cljs.core.rest(remaining_tokens);
var G__28187 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28186;
name_tokens = G__28187;
continue;
} else {
...
var vec__28014 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28014,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28014,(1),null);
var vec__28017 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28017,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28017,(1),null);
var vec__28020 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28020,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28020,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28020,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28020,(3),null);
...
var vec__28037 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28037,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28037,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28037,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28037,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28037,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28037,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28044 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28044,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28044,(1),null);
var vec__28047 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28047,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28047,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28061 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28061) : devtools.munging.parse_fn_info_deep.call(null,G__28061));
})()));
}
} else {
return fn_info;
...
var G__28232 = (arity + (1));
var G__28233 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28079){
var vec__28080 = p__28079;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28080,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28080,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28086_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28086_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28087_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28087_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28091){
var vec__28092 = p__28091;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28092,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28089){
var G__28090 = cljs.core.first(seq28089);
var seq28089__$1 = cljs.core.next(seq28089);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28090,seq28089__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28107__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28107__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28107__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28107__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28108 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28108,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28108,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28108,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28108,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28108,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28108,(5),null);
...
var o__27736__auto__ = f;
return (o__27736__auto__["getBasis"]).call(o__27736__auto__);
});
/**
...
}catch (e28117){var _e__27752__auto__ = e28117;
...
var G__28259 = (obj[cljs.core.first(path)]);
var G__28260 = cljs.core.rest(path);
obj = G__28259;
path = G__28260;
continue;
} else {
...
var _STAR_ = (function (accum,p__28132){
var vec__28133 = p__28132;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28133,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28133,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28140){
var vec__28141 = p__28140;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28141,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28141,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28141,(2),null);
...
var post_process = (function (p__28147){
var vec__28148 = p__28147;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28148,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28148,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28145_SHARP_){
return (obj[cljs.core.first(p1__28145_SHARP_)]);
}),sorted_matches);
