...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__34973_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__34973_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__34973_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__34976){
var vec__34977 = p__34976;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34977,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34977,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__34980,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34981__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34981__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34981__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__34987 = (function (){var or__4126__auto__ = color;
...
var fexpr__34986 = (function (){var G__34988 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__34988) : style_map.call(null,G__34988));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__34989){
var vec__34990 = p__34989;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34990,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34990,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34990,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__34997){
var vec__34998 = p__34997;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34998,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34998,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34998,(2),null);
...
var vec__35009 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35009,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35009,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35009,(2),null);
...
var G__35155 = cljs.core.next(remaining_cvec);
var G__35156 = new_idx;
var G__35157 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__35155;
idx = G__35156;
out = G__35157;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__35025,cursor_vec){
var vec__35026 = p__35025;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35026,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35026,(1),null);
var focus_vec = vec__35026;
...
var vec__35030 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35030,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35030,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__35035){
var vec__35036 = p__35035;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35036,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35036,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__35049,existing_count){
var vec__35050 = p__35049;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35050,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35050,(1),null);
...
return cljs.core.filterv((function (p1__35045_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__35045_SHARP_))));
...
var vec__35072 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35072,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35072,(1),null);
var cvec_element = vec__35072;
if((cvec_element == null)){
var G__35175 = cljs.core.next(cvec_nl);
var G__35176 = (idx + (1));
var G__35177 = start;
var G__35178 = out;
cvec_nl = G__35175;
...
var G__35179 = cljs.core.next(cvec_nl);
var G__35180 = (idx + (1));
var G__35181 = idx;
var G__35182 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__35179;
idx = G__35180;
start = G__35181;
out = G__35182;
...
var G__35183 = cljs.core.next(cvec_nl);
var G__35184 = (idx + (1));
var G__35185 = (idx + (1));
var G__35186 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__35183;
idx = G__35184;
start = G__35185;
out = G__35186;
...
var G__35189 = cljs.core.next(cvec_nl);
var G__35190 = (idx + (1));
var G__35191 = idx;
var G__35192 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__35189;
idx = G__35190;
start = G__35191;
out = G__35192;
...
var G__35193 = cljs.core.next(cvec_nl);
var G__35194 = (idx + (1));
var G__35195 = start;
var G__35196 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__35193;
idx = G__35194;
start = G__35195;
out = G__35196;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__35082_SHARP_,p2__35081_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__35081_SHARP_)){
return cljs.core.reduced(p1__35082_SHARP_);
} else {
return (p1__35082_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__35110,p__35111){
var vec__35112 = p__35110;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35112,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35112,(1),null);
var vec__35115 = p__35111;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35115,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35115,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__35130,cvec,focus_vec){
...
var options = map__35132__$1;
var map__35133 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35132__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35133__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35133__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35133__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35128_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__35128_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
