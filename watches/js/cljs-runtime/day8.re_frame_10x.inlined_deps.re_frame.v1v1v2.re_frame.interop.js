...
return [(function (){var pred__33800 = cljs.core.instance_QMARK_;
var expr__33801 = reactive_val;
if(cljs.core.truth_((pred__33800.cljs$core$IFn$_invoke$arity$2 ? pred__33800.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__33801) : pred__33800.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__33801)))){
return "ra";
} else {
if(cljs.core.truth_((pred__33800.cljs$core$IFn$_invoke$arity$2 ? pred__33800.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__33801) : pred__33800.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__33801)))){
return "rc";
} else {
if(cljs.core.truth_((pred__33800.cljs$core$IFn$_invoke$arity$2 ? pred__33800.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__33801) : pred__33800.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__33801)))){
return "rx";
} else {
if(cljs.core.truth_((pred__33800.cljs$core$IFn$_invoke$arity$2 ? pred__33800.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__33801) : pred__33800.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__33801)))){
return "tr";
} else {
return "other";
}
