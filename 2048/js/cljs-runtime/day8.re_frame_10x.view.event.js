...
var G__40413 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,i_s);
var G__40414 = (i_s + (1));
var G__40415 = (i_s_SINGLEQUOTE_ + (1));
v = G__40413;
i_s = G__40414;
i_s_SINGLEQUOTE_ = G__40415;
continue;
} else {
var G__40416 = v;
var G__40417 = (i_s + (1));
var G__40418 = i_s_SINGLEQUOTE_;
v = G__40416;
i_s = G__40417;
i_s_SINGLEQUOTE_ = G__40418;
continue;
...
var vec__40372 = day8.re_frame_10x.view.event.collapse_whitespace_and_index(form_str);
var form_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40372,(0),null);
var reindex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40372,(1),null);
...
var vec__40375 = result;
var vec__40378 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40375,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40378,(0),null);
var pre_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40378,(1),null);
var matched_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40378,(2),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40375,(1),null);
...
var start = (function (){var G__40387 = form_str__$1;
var G__40387__$1 = (((G__40387 == null))?null:clojure.string.index_of.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([search_str], 0)),G__40387));
if((G__40387__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__40387__$1);
}
})();
...
var end = (function (){var G__40388 = start;
var G__40388__$1 = (((G__40388 == null))?null:(length + G__40388));
if((G__40388__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__40388__$1);
}
})();
...
var vec__40390 = day8.re_frame_10x.view.event.find_bounds(form_str,new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(highlighted_form),new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431).cljs$core$IFn$_invoke$arity$1(highlighted_form));
var start_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40390,(0),null);
var end_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40390,(1),null);
...
return null;
});})(i__40401,id,first_QMARK_,frag,c__4527__auto__,size__4528__auto__,b__40402,s__40400__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (i__40401,id,first_QMARK_,frag,c__4527__auto__,size__4528__auto__,b__40402,s__40400__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40402),day8$re_frame_10x$view$event$event_fragments_$_iter__40399(cljs.core.chunk_rest(s__40400__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40402),null);
}
} else {
var frag = cljs.core.first(s__40400__$2);
return cljs.core.cons((function (){var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(frag);
var first_QMARK_ = (id === (0));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"code-fragment",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),((first_QMARK_)?null:"-1px")], null),new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-enter","on-mouse-enter",-1664921661),((function (id,first_QMARK_,frag,s__40400__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","hover-form","code/hover-form",1557522458),frag], null));

return null;
});})(id,first_QMARK_,frag,s__40400__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (id,first_QMARK_,frag,s__40400__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","exit-hover-form","code/exit-hover-form",-202062797),frag], null));
...
})(),day8$re_frame_10x$view$event$event_fragments_$_iter__40399(cljs.core.rest(s__40400__$2)));
}
} else {
return null;
}
