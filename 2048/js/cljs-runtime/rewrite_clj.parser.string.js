...
if((c === "\n")){
var G__36570 = escape_QMARK_;
var G__36571 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__36570;
lines = G__36571;
continue;
} else {
buf.append(c);

var G__36572 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__36573 = lines;
escape_QMARK_ = G__36572;
lines = G__36573;
continue;
...
var G__36563 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__36563) : rewrite_clj.node.string_node.call(null,G__36563));
});
...
var G__36566 = cljs.core.re_pattern(regex);
var G__36567 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__36566,G__36567) : rewrite_clj.node.token_node.call(null,G__36566,G__36567));
});
