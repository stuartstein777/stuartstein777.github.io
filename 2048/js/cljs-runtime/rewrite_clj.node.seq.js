...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k36166,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k36166,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__36182){
var vec__36183 = p__36182;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36183,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36183,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__36165){
var self__ = this;
var G__36165__$1 = this;
return (new cljs.core.RecordIter((0),G__36165__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this36167,other36168){
var self__ = this;
var this36167__$1 = this;
return (((!((other36168 == null)))) && ((this36167__$1.constructor === other36168.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36167__$1.tag,other36168.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36167__$1.wrap_fn,other36168.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36167__$1.wrap_length,other36168.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36167__$1.seq_fn,other36168.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36167__$1.children,other36168.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36167__$1.__extmap,other36168.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__36196 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__36196) : self__.seq_fn.call(null,G__36196));
}));
...
var self__ = this;
var this$__$1 = this;
var G__36200 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__36200) : self__.wrap_fn.call(null,G__36200));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__36165){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__36213 = cljs.core.keyword_identical_QMARK_;
var expr__36214 = k__4388__auto__;
if(cljs.core.truth_((pred__36213.cljs$core$IFn$_invoke$arity$2 ? pred__36213.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__36214) : pred__36213.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__36214)))){
return (new rewrite_clj.node.seq.SeqNode(G__36165,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36213.cljs$core$IFn$_invoke$arity$2 ? pred__36213.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__36214) : pred__36213.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__36214)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__36165,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36213.cljs$core$IFn$_invoke$arity$2 ? pred__36213.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__36214) : pred__36213.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__36214)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__36165,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36213.cljs$core$IFn$_invoke$arity$2 ? pred__36213.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__36214) : pred__36213.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__36214)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__36165,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__36213.cljs$core$IFn$_invoke$arity$2 ? pred__36213.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__36214) : pred__36213.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__36214)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__36165,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__36165),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__36165){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__36165,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__36170){
var extmap__4419__auto__ = (function (){var G__36249 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__36170,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__36170),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__36170),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__36170),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__36170),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__36170),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__36255_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__36255_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__36256_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__36256_SHARP_);
}),children);
});
