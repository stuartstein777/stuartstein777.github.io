...
var G__35367 = new_next_nonws_QMARK_;
index = G__35365;
skip_to_right_QMARK_ = G__35366;
next_nonws_QMARK_ = G__35367;
continue;
}
}
break;
...
var G__35369 = zprint.focus.next_ssv(ssv,index);
var G__35370 = (moves - (1));
index = G__35369;
moves = G__35370;
continue;
}
...
var G__35371 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__35372 = cljs.core.next(nwp);
idx = G__35371;
nwp = G__35372;
continue;
}
