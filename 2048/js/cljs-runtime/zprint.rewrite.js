...
var G__37757 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__37757;
continue;
} else {
var G__37758 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__37758;
continue;
}
} else {
var G__37762 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__37762;
continue;
}
}
...
var G__37730 = zloc;
var G__37731 = (function (){var G__37732 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__37733 = zloc;
var G__37733__$1 = (((G__37733 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__37733) : rewrite_clj.zip.node.call(null,G__37733)));
if((G__37733__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__37733__$1) : zprint.zutil.edn_STAR_.call(null,G__37733__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__37732) : rewrite_clj.zip.root.call(null,G__37732));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__37730,G__37731) : rewrite_clj.zip.replace.call(null,G__37730,G__37731));
});
/**
...
var G__37771 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__37771;
continue;
}
break;
...
var G__37774 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__37775 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__37774;
out = G__37775;
continue;
} else {
...
var G__37778 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__37779 = cljs.core.next(new_loc);
var G__37780 = replaced_loc;
nloc = G__37778;
new_loc = G__37779;
last_loc = G__37780;
continue;
...
return zprint.rewrite.sort_val((function (){var G__37751 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__37751) : rewrite_clj.zip.down.call(null,G__37751));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__37753_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__37753_SHARP_) : rewrite_clj.zip.tag.call(null,p1__37753_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__37753_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__37753_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
