...
return [(function (){var pred__39292 = cljs.core.instance_QMARK_;
var expr__39293 = reactive_val;
if(cljs.core.truth_((pred__39292.cljs$core$IFn$_invoke$arity$2 ? pred__39292.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__39293) : pred__39292.call(null,reagent.ratom.RAtom,expr__39293)))){
return "ra";
} else {
if(cljs.core.truth_((pred__39292.cljs$core$IFn$_invoke$arity$2 ? pred__39292.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__39293) : pred__39292.call(null,reagent.ratom.RCursor,expr__39293)))){
return "rc";
} else {
if(cljs.core.truth_((pred__39292.cljs$core$IFn$_invoke$arity$2 ? pred__39292.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__39293) : pred__39292.call(null,reagent.ratom.Reaction,expr__39293)))){
return "rx";
} else {
if(cljs.core.truth_((pred__39292.cljs$core$IFn$_invoke$arity$2 ? pred__39292.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__39293) : pred__39292.call(null,reagent.ratom.Track,expr__39293)))){
return "tr";
} else {
return "other";
}
