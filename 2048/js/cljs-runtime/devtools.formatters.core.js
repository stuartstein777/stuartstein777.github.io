...
}catch (e30542){var _e__28151__auto__ = e30542;
return false;
...
}catch (e30544){var _e__28151__auto__ = e30544;
return false;
...
}catch (e30556){var _e__28151__auto__ = e30556;
return false;
...
}catch (e30562){var _e__28151__auto__ = e30562;
return false;
...
}catch (e30576){var _e__28151__auto__ = e30576;
return false;
}})())){
...
}catch (e30592){var _e__28151__auto__ = e30592;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__30597 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30598 = (function (){var or__4126__auto__ = config;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30598);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30597);
}});
});
...
return (function() { 
var G__30647__delegate = function (args){
...
while (G__30657__i < G__30657__a.length) {G__30657__a[G__30657__i] = arguments[G__30657__i + 0]; ++G__30657__i;}
  args = new cljs.core.IndexedSeq(G__30657__a,0,null);
} 
return G__30647__delegate.call(this,args);};
G__30647.cljs$lang$maxFixedArity = 0;
G__30647.cljs$lang$applyTo = (function (arglist__30658){
var args = cljs.core.seq(arglist__30658);
return G__30647__delegate(args);
});
